...
| ------------------------- | ------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Project                   | `project/created`         | Project processor, after `session.projects.get(slug).create(...)` appends `project/create-requested`  | The request batch births Notification and both root processors. The Project reaction creates the root Capability Host, primary Scheduler, config Repo, and Email router. After the config repo builds, it installs an exact-request project-worker subscription and waits for that worker to consume `project/create-requested`; it then atomically installs the permanent feed and appends terminal `project/created`. Config-repo or delivery-policy failures append terminal `project/create-failed`; unclassified worker-build errors, transient availability, and timeouts redeliver. |
| Repo                      | `repos/created`           | `project.repos.get(path).create(...)`, global repo creation, or Project bootstrap for `/repos/config` | Appends `repos/create-requested`, subscribes Repo, provisions or imports the artifact, then emits `repos/created` (or `repos/create-failed`), which is cross-posted to `/`.                                                                                                                                                                                                                                                                                                                                                                                                                |
