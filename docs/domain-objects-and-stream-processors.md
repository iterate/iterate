...
| ------------------------- | ------------------------- | ----------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Project                   | `project/created`         | Project processor, after `session.projects.get(slug).create(...)` appends `project/create-requested`  | The request batch births Notification and both root processors. The Project reaction creates the root Capability Host, primary Scheduler, config Repo, and Email router. After the trusted seeded config worker builds and answers a readiness probe, it atomically installs the permanent root worker feed (starting after `project/create-requested`) and appends terminal `project/created`. Config-repo or deterministic worker source-build failures append terminal `project/create-failed`; transient availability redelivers. Userspace does not consume a creation hook. |
