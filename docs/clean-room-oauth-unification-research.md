...
Evidence: [credential union and gate](../packages/v3/project-worker/src/session.ts),
[cookie/token signing](../packages/v3/project-worker/src/principal.ts),
[console app links](../packages/v3/project-worker/src/control-plane.ts#L618-L661),
[project ingress](../packages/v3/project-worker/src/worker.ts#L44-L143), and
[provider configuration](../packages/v3/project-worker/src/control-plane.ts#L858-L896).
...
([Configuration and external-token hook](../packages/v3/project-worker/src/control-plane.ts),
[consent completion](../packages/v3/project-worker/src/control-plane.ts#L729-L760).)

The old remote-app mechanism is accurately described in
[remote-apps.md](remote-apps.md): the config worker proxies the project-host request,
...
- Console sign-out only clears a signed cookie. There is no server-side browser-session
  ...
  ([Login/sign-out](../packages/v3/project-worker/src/control-plane.ts#L595-L611),
  [cookie implementation](../packages/v3/project-worker/src/principal.ts#L220-L273).)
- Selected project IDs become a stored permission snapshot. `reachOf()` chooses the
  ...
  ([Reach](../packages/v3/project-worker/src/control-plane.ts#L90-L96),
  [project admission](../packages/v3/project-worker/src/control-plane.ts#L249-L260).)
...
[current capability session lifetime](../packages/v3/project-worker/src/session.ts).)
