...
`apps/os` is the primary product app. It provides the authenticated web UI, itx capability handles over `/api/itx`, Iterate Auth Worker integration, D1/sqlfu projections, and Durable Objects for project lifecycle, ingress, agents, repositories, workspaces, itx contexts, and shared streams.
