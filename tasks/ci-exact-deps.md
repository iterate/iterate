...
- Added and first observed a failing binary-input regression, then fixed fingerprinting to preserve raw bytes. Added an environment-change miss test. All 11 dependency integration tests pass. Full repository typecheck and knip pass; lint is running.
