...
- [x] Make mobile-created projects expose their config repo before they open. _Creation now waits for terminal `project/created`, which is committed only after `/repos/config` exists and the project worker consumes `project/create-requested`._
