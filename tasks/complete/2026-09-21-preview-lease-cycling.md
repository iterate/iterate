...
Status: complete. Real CI cycling is implemented and the final code run passed the full suite, retirement, trace collection and human-preview restoration. Prepared-slot smoke measured 26.7–37.7s versus 117.5s with the guard. Earlier intermittent failures remain documented in PR #2751; no merge is authorized.
