...
No PR: review against `codex/preview-do-storage-cleanup` (PR #2693).
...
- [x] Push a no-PR stacked branch and provide its compare link. *`codex/preview-change-types-v2`, based on `codex/preview-do-storage-cleanup`; no PR created.*
