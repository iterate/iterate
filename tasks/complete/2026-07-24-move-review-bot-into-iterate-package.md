...
- 2026-07-24: A final Bugbot pass caught config updates reusing one idempotency key with a changed virtual-module body. Subscription event identity now includes the complete serialized app config while the stable subscription key still replaces the active runtime.
