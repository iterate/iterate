...
- [x] Update project-worker runtime fixtures and e2e examples that demonstrate project authoring. _Project ingress fixtures and itx e2e catalogue runner now use the class entrypoint and `project-worker` runtime label._
