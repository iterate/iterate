...
**Status summary (for skimmers):** completed and merged in PR #2044. This task established `apps/mobile` with sign-in, project selection, chat, live activity, and approvals; subsequent physical-device/native work superseded its Expo Go assumptions in PR #2084. The body below is preserved as the implementation-era record, while current work lives in `tasks/mobile-native-followups.md`.
...
## Decisions (from the grill-you interview — full trail in `tasks/complete/2026-07-16-os-ios-app.interview.md`)
