...
- Validation: 96 CI-script tests, 45 test-support passes plus one expected failure, and 37 dashboard tests pass; all three affected workspace typechecks and scoped lint pass. The refreshed GitHub-Markdown-rendered example shows 3/20 and 8/20 streaks surviving an interrupted run.
