...
Status: 7/25 qualifying natural canonical preview occurrences are queryable. The restored approval and notification specs passed first attempt in all seven; 18 natural occurrences remain. Three later natural runs are excluded because their complete finalizers reported unrelated failures. Exact-version traces classified the original stream-idle failure as a test observation race; the first proof exposed barrier-owned lifecycle facts, and the corrected fence is awaiting canonical proof.
