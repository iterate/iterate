...
- [Writing & testing stream processors](docs/writing-stream-processors.md) — side-effect guarantees, the obligation/drive pattern, eviction recovery, staleness policy, and the node test harness
