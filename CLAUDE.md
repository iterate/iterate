...
- [Intercepted models](docs/intercepted-models.md) — `intercepted/*` via `itx.ai.intercept(handler)`: deterministic agent/AI testing, the session-bound lifetime + 4901 recovery contract
