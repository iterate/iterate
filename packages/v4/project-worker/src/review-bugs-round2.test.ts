      ...
      fetch: async (request: Request) => {
        ...
        const result =
          body.method === "initialize"
            ...
            : {
                tools: [
                  { name: "then", inputSchema: { type: "object" } },
...
// edge#10 — JSON5 comments are syntax, not expression delimiters or holes. The scanner skips them
// before it finds a call's closing paren or lexes a target marker.
