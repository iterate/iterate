...
//
// A deliberate sibling of `browser-event-feed` (packages/streams): settled
...
import { createSchemaEnsurer } from "@iterate-com/streams/browser/ensure-schema-once";
import type { SqlClient, SqlValue } from "@iterate-com/streams/browser/stream-browser-db";
