// core/logs.ts — ONE structured console line per call, distilled from cloudflare-os
...
// UNEXPECTED failures don't come here — they go through reportIssue in core/errors.ts.
