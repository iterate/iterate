...
// version refolds, live-state publishing — is core/processor.ts's `StreamProcessor`, unchanged and
...
import { DurableObjectNameCodec, type DurableObjectAddress } from "./core/durable-object-names.ts";
