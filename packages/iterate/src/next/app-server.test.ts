...
// again" page (a project the page named, or a permission the app asks for) whose one button is a
// same-origin POST that ends this app's session and returns to the very same login URL.
import { describe, expect, test } from "vitest";
import { appAuth } from "./app-server.ts";

const ISSUER = "https://os.example";

/** One app session the platform honours, holding `scopes`. */
