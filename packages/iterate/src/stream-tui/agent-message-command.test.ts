...
describe("sendAgentMessage", () => {
  test("leaves the mutation response out of the feed so delayed connection events stay ordered", async () => {
    ...
    // The ordered, replay-capable event connection is the only live feed writer.
