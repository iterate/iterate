...
export interface paths {
  ...
  "/apps/{app_name}/machines/{machine_id}/metadata": {
     ...
     */
    patch: operations["Machines_patch_metadata"];
    trace?: never;
  };
  ...
  App_IPAssignments_create: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["IPAssignment"];
        };
      };
    };
  };
  ...
  Machines_org_list: {
    parameters: {
      query?: {
        ...
        cursor?: string;
        /** @description The number of machines to fetch (max of 1000). If omitted, this is set to 500 by default */
        limit?: number;
      };
      header?: never;
      path: {
