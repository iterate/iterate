...
export default defineConfig({
  ...
  processes: [
    ...
    },
    {
      ...
      healthCheck: {
        url: "http://registry.iterate.localhost/api/__internal/health",
        intervalMs: 2_000,
      },
    },
    ...
    },
    {
      ...
      healthCheck: {
        url: "http://example.iterate.localhost/api/__internal/health",
        intervalMs: 2_000,
      },
      dependsOn: ["daemon"],
      options: {
    ...
    },
    {
      ...
      healthCheck: {
        url: "http://events.iterate.localhost/api/__internal/health",
        intervalMs: 2_000,
      },
      dependsOn: ["daemon"],
      options: {
