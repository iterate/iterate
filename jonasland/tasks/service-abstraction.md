...
await deployment.startService({
manifest: manifest,
config: {
// inferred from service manifest?
},
serviceName?: "bla" //

})

# Questions we need to explain

- How does the "default" service on the naked public host get determined?
