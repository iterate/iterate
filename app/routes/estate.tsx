...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { name: "description", content: "Manage your estate and connect to GitHub" },
  ];
}
      ...
      <div className="max-w-4xl mx-auto px-8 pt-16 pb-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed mb-8">
            Connect your GitHub account to automatically manage your digital estate, 
            backup important repositories, and ensure your code legacy is preserved.
          </p>
        </div>
