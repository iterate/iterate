...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { name: "description", content: "Connect your accounts to enable integrations across the platform" },
  ];
}
    ...
    setIntegrations(prev => 
      prev.map(integration => 
        integration.id === integrationId 
          ? { ...integration, isConnected: true, connections: integration.connections + 1 }
          : integration
      )
    );
  };
            ...
            <CardContent className="pt-0">
              <div className="flex items-center gap-4 text-sm text-muted-foreground mb-4">
                <div className="flex items-center gap-1">
                  ...
                  <span>{integration.connections} connection{integration.connections !== 1 ? 's' : ''} in {integration.apps} app{integration.apps !== 1 ? 's' : ''}</span>
                </div>
              </div>
