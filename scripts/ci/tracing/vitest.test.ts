...
test("real Vitest tests appear in CI traces with normalized outcomes and aggregate retries", () => {
  ...
  const unfinishedStart = fixture.events.find((event: any) => event.title === "passes after retry");
