...
- [CI and test telemetry](docs/ci-test-telemetry.md) — one PostHog model and dashboards for Vitest/Playwright/Node tests, failures, retries, phases, GitHub Actions, Depot, and review bots
