...
const links = [
  { label: "Events UI", host: "events.iterate.localhost", path: "/" },
  { label: "Orders UI", host: "orders.iterate.localhost", path: "/" },
  ...
  { label: "Events OpenAPI", host: "events.iterate.localhost", path: "/api/openapi.json" },
  { label: "Orders OpenAPI", host: "orders.iterate.localhost", path: "/api/openapi.json" },
...
<html lang="en">
  ...
  <body>
    <main>
      <h1>jonasland2</h1>
      <p>Minimal home service with local links.</p>
      <ul id="links"></ul>
    </main>
    <script>
