...
// oxlint-disable-next-line no-restricted-imports -- the fake `itx`'s append refuses what the platform's app wall refuses: a fake borrowing the real policy, never runtime code crossing the line
