...
// `itx.files.put` takes as a string. The form clears itself once `onSend` resolves.
  ...
  return (
    ...
    >
      ...
      <PromptInputFooter>
        ...
        {error ? <span className="min-w-0 truncate text-xs text-destructive">{error}</span> : null}
