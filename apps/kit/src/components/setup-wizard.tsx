...
import { flashDevice, type FlashProgress } from "../firmware/flash-device.ts";
 ...
 * dialog is open while `preparing` has been started, and closing it resets both.
 */
export function SetupWizard({
  ...
  return (
    ...
    >
      <DialogContent showCloseButton={!flashing.isPending} className="sm:max-w-md">
        {preparing.isPending && (
          <>
            <DialogHeader>
        ...
        {preparing.isSuccess && flashing.isIdle && (
          ...
          >
            <DialogHeader>
              ...
              <DialogDescription>
                {preparing.variables.project.slug} is ready. Next, write the firmware to the board.
              </DialogDescription>
            </DialogHeader>
            <ol className="flex list-decimal flex-col gap-2 pl-5">
              <li>Plug the board into this computer with a USB data cable (some only charge).</li>
              <li>
        ...
        {preparing.isSuccess && flashing.isSuccess && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                It’s restarting, then it joins {preparing.variables.wifi.ssid}. That takes about 20
                seconds.
              </DialogDescription>
            </DialogHeader>
            <ol className="flex list-decimal flex-col gap-2 pl-5">
              ...
              <li>
                Ask “What’s my project called?” It should say “{preparing.variables.project.slug}”.
              </li>
            </ol>
            <p className="text-muted-foreground">
              If it can’t connect, check the Wi-Fi: the board only joins 2.4 GHz networks. Then
              flash it again with the right network and password.
            </p>
            <DialogFooter>
