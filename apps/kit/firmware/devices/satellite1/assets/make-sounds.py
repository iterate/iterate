#!/usr/bin/env python3
"""Bake the Satellite1 UI sounds into a C include.
...
announcement is an OpenAI TTS render in
marin — the same voice the assistant answers in. Regenerate with:

  python3 make-sounds.py <dir-with-wavs>  > satellite1_sounds_generated.inc
"""
...
for cname, fname in NAMES:
    ...
    print(f"static const uint8_t satellite1_sound_{cname}[] = {{")
