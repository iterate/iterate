...
enum iterate_kit_voicelab_state {
  ...
  ITERATE_KIT_VOICELAB_GETTING_STREAM_HEAD,
...
enum iterate_kit_voicelab_failure {
  ...
  ITERATE_KIT_VOICELAB_FAILURE_STREAM_HEAD_CALL,
  ITERATE_KIT_VOICELAB_FAILURE_STREAM_HEAD_REJECTED,
  ITERATE_KIT_VOICELAB_FAILURE_STREAM_HEAD_RESULT,
...
struct iterate_kit_voicelab {
  ...
  /* Highest open/batch scan position. This is not the event dedupe marker. */
  int64_t resume_after_offset;
