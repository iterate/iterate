...
export class ItxProcessor
  extends StreamProcessor<typeof ItxContract, object, ItxProcessorContext>
  implements ItxProcessorRpc
{
  ...
  constructor(
    args: StreamProcessorConstructorArgs<typeof ItxContract, object, ItxProcessorContext> & {
      dynamicWorkers: DynamicWorkersRpcTarget;
    },
  ) {
    super(args);
