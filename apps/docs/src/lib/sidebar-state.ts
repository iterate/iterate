 ...
 * pattern apps/os and apps/tasks use. The sidebar itself writes the cookie
 * on toggle. First visit (no cookie) starts COLLAPSED: a docs deep link is
 * about one document, so the rail is enough until asked for.
 */
