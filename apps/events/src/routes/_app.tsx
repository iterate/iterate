...
const getProjectId = createServerFn({ method: "GET" }).handler(() => {
  const request = getRequest();
  return resolveHostProjectId(new URL(request.url).hostname) ?? defaultProjectId;
});
...
function AppLayout() {
  const { projectId, sidebarDefaultOpen } = Route.useLoaderData();
