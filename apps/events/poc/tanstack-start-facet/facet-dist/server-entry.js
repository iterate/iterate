...
} from "./assets/jsx-runtime-B9Euz7RS.js";
import {
  D as createLRUCache,
  M as decodePath,
  O as invariant,
  ...
  u as rootRouteId,
} from "./assets/__23tanstack-start-server-fn-resolver-CUyURu_5.js";
import {
  ...
  t as appRouter,
  v as CatchBoundary,
  w as createMemoryHistory,
  x as resolveManifestAssetLink,
  y as ErrorComponent,
} from "./assets/router-ORs1rOzB.js";
import {
...
import { Z as resolveMaybeOptionalOptions } from "./assets/client.DrB9nq_G-C5sxXqjr.js";
import { n as ServerPeer } from "./assets/dist-DwuzSrJ6.js";
import "./assets/contract-DV24D5zz.js";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-j86X2qfu.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-B6ymJRs3.js"),
    import("./assets/start--v9zjBbu.js"),
    import("./assets/__23tanstack-start-plugin-adapters-W3W76PgH.js"),
  ]);
  return {
    routerEntry,
    startEntry,
  ...
  async fetch(request) {
    ...
    if (request.headers.get("Upgrade") === "websocket" && url.pathname === "/api/rpc-ws") {
      ...
      server.addEventListener("message", (event) => {
        ...
        const peer = { send: (d) => server.send(d) };
        const message =
          typeof data === "string"
            ? {
                rawData: data,
      ...
      server.addEventListener("close", () => {
        wsRpcHandler.close({ send: (d) => server.send(d) });
      });
      return new Response(null, {
        status: 101,
        webSocket: client,
