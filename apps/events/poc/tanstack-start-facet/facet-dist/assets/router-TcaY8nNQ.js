import {
  ...
  O as matchContext,
  P as requireReactDom,
  Q as exactPathTest,
  R as removeTrailingSlash,
  S as React,
  T as jsxRuntimeExports,
  U as isModuleNotFoundError,
  V as useHydrated,
  W as escapeHtml,
  X as getAssetCrossOrigin,
  Y as resolveManifestAssetLink,
  Z as Outlet,
  _ as TSS_SERVER_FUNCTION,
  $ as getServerFnById,
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, {
    client: queryClient,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(RootDocument, {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", {
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/counter", children: "Counter" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, {
                to: "/server-fns",
                children: "Server Fns",
              }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/things", children: "Things" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
                className: "badge",
                children: "DO Facet",
              }),
...
const $$splitComponentImporter$4 = () => import("./things-Bq6MPbuf.js");
const Route$4 = createFileRoute("/things")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component"),
});
const $$splitComponentImporter$3 = () => import("./server-fns-BiHhGmIf.js");
const Route$3 = createFileRoute("/server-fns")({
...
const $$splitComponentImporter$2 = () => import("./counter-DjBNqCGQ.js");
const getCount = createServerFn({
  method: "GET",
}).handler(createSsrRpc("380e4f27c86b2e828107a0454e2715b4169bf11b02de11d0dc9ad75de7d85a7e"));
const Route$2 = createFileRoute("/counter")({
  loader: async () => {
    return getCount();
  },
  component: lazyRouteComponent($$splitComponentImporter$2, "component"),
});
const $$splitComponentImporter$1 = () => import("./about-QdvM-Fg_.js");
const Route$1 = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
});
const $$splitComponentImporter = () => import("./index-196cdicC.js");
const getServerInfo = createServerFn({
  method: "GET",
}).handler(createSsrRpc("bcc06e110064ff306a20f0e07346328125999211fd273f8af0a4f8e5fe43cba5"));
...
const ThingsRoute = Route$4.update({
  id: "/things",
  path: "/things",
  getParentRoute: () => Route$5,
});
const ServerFnsRoute = Route$3.update({
  id: "/server-fns",
  path: "/server-fns",
  getParentRoute: () => Route$5,
});
const CounterRoute = Route$2.update({
  id: "/counter",
  path: "/counter",
  getParentRoute: () => Route$5,
});
