var e = Object.defineProperty,
  ...
  r = (n, r, i, a) => {
    for (var o = a > 1 ? void 0 : a ? t(r, i) : r, s = n.length - 1, c; s >= 0; s--)
      (c = n[s]) && (o = (a ? c(r, i, o) : c(o)) || o);
    return (a && o && e(r, i, o), o);
  },
  i = (e, t) => (n, r) => t(n, r, e),
  a = `Terminal input`,
  o = { get: () => a, set: (e) => (a = e) },
...
function f(e, t, n, r) {
  (e.stopPropagation(), e.clipboardData && p(e.clipboardData.getData(`text/plain`), t, n, r));
}
function p(e, t, n, r) {
  ((e = l(e)),
    (e = u(
...
function h(e, t, n, r, i) {
  (m(e, t, n), i && r.rightClickSelect(e), (t.value = r.selectionText), t.select());
}
function g(e) {
  return e > 65535
    ? ((e -= 65536),
...
var ee = class {
  ...
  ie = class e {
    constructor() {
      ((this.fg = 0), (this.bg = 0), (this.extended = new ae()));
    }
    static toColorRGB(e) {
  ...
  v = class e extends ie {
    constructor() {
      (super(...arguments),
        (this.content = 0),
        (this.fg = 0),
        (this.bg = 0),
        (this.extended = new ae()),
        (this.combinedData = ``));
    }
...
function y(e) {
  ...
  return ((t._id = e), ce.set(e, t), t);
}
function ue(e, t, n) {
  t[oe] === t ? t[se].push({ id: e, index: n }) : ((t[se] = [{ id: e, index: n }]), (t[oe] = t));
}
var b = y(`BufferService`),
  de = y(`CoreMouseService`),
  fe = y(`CoreService`),
  pe = y(`CharsetService`),
  x = y(`InstantiationService`),
  me = y(`LogService`),
  S = y(`OptionsService`),
  he = y(`OscLinkService`),
  ge = y(`UnicodeService`),
  _e = y(`DecorationService`),
  C = class {
    constructor(e, t, n) {
      ...
      for (let t = 0; t < o; t++)
        if (!(c === -1 && !n.hasContent(t))) {
          ...
          if (l || (c !== -1 && t === o - 1)) {
            ...
            if (n) {
              let a = { start: { x: c + 1, y: e }, end: { x: t + +(!l && t === o - 1), y: e } },
                s = !1;
              ...
              s ||
                r.push({
                  text: n,
                  range: a,
                  activate: (e, t) => (i ? i.activate(e, t, a) : ve(e, t)),
...
var w = y(`CharSizeService`),
  T = y(`CoreBrowserService`),
  ye = y(`MouseService`),
  E = y(`RenderService`),
  be = y(`SelectionService`),
  xe = y(`CharacterJoinerService`),
  D = y(`ThemeService`),
  Se = y(`LinkProviderService`),
  Ce = new (class {
    constructor() {
      ((this.listeners = []),
...
function we(e) {
  Ee(e) || Ce.onUnexpectedError(e);
}
var Te = `Canceled`;
function Ee(e) {
  return e instanceof De ? !0 : e instanceof Error && e.name === Te && e.message === Te;
}
var De = class extends Error {
  constructor() {
    (super(Te), (this.name = this.message));
  }
};
function Oe(e) {
  return Error(e ? `Illegal argument: ${e}` : `Illegal argument`);
}
var ke = class e extends Error {
    constructor(e) {
...
var Me = class e {
  ...
  findLastMonotonous(t) {
    ...
    let n = je(this._array, t, this._findLastMonotonousLastIdx);
    return ((this._findLastMonotonousLastIdx = n + 1), n === -1 ? void 0 : this._array[n]);
  }
};
Me.assertInvariants = !1;
function O(e, t = 0) {
  ...
  Ie = class e {
    ...
    findLastMaxBy(e) {
      let t,
        n = !0;
      return (
        this.iterate((r) => ((n || Ne.isGreaterThan(e(r, t))) && ((n = !1), (t = r)), !0)), t
      );
    }
  };
Ie.empty = new Ie((e) => {});
...
`)
          ...
          .filter((e) => e !== ``);
        return (
          t(n, [`Error`, /^trackDisposable \(.*\)$/, /^DisposableTracker.trackDisposable \(.*\)$/]),
          n.reverse()
        );
      }
      let i = new Re();
...
function Je(e, t) {
  if (He) for (let n of e) He.setParent(n, t);
}
function Ye(e) {
  return (He?.markAsSingleton(e), e);
}
function Xe(e) {
  if (Be.is(e)) {
    let t = [];
...
var Qe = class e {
  constructor() {
    ((this._toDispose = new Set()), (this._isDisposed = !1), Ge(this));
  }
  dispose() {
    this._isDisposed || (Ke(this), (this._isDisposed = !0), this.clear());
  }
  get isDisposed() {
...
Qe.DISABLE_DISPOSED_WARNING = !1;
var $e = Qe,
  A = class {
    constructor() {
      ((this._store = new $e()), Ge(this), qe(this._store, this));
    }
    dispose() {
      (Ke(this), this._store.dispose());
    }
    _register(e) {
...
var et = class {
    ...
    set value(e) {
      this._isDisposed ||
        e === this._value ||
        (this._value?.dispose(), e && qe(e, this), (this._value = e));
    }
    clear() {
      this.value = void 0;
    }
    dispose() {
      ((this._isDisposed = !0), Ke(this), this._value?.dispose(), (this._value = void 0));
    }
    clearAndLeak() {
      let e = this._value;
  ...
  tt = typeof window == `object` ? window : globalThis,
  nt = class e {
    constructor(t) {
...
var j = nt,
  ...
  it = globalThis.performance && typeof globalThis.performance.now == `function`,
  at = class e {
    static create(t) {
      return new e(t);
    }
    constructor(e) {
      ((this._now =
        it && e === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance)),
...
((e) => {
  ...
  e.signal = s;
  function c(...e) {
    return (t, n = null, r) => d(Ze(...e.map((e) => e((e) => t.call(n, e)))), r);
  }
  e.any = c;
  function l(e, t, n, r) {
    let a = n;
  ...
  class te {
    ...
    filter(e) {
      return (this.steps.push((t) => (e(t) ? t : ee)), this);
    }
    reduce(e, t) {
      let n = t;
    ...
    latch(e = (e, t) => e === t) {
      ...
      return (
        this.steps.push((r) => {
          let i = t || !e(r, n);
          return ((t = !1), (n = r), i ? r : ee);
        }),
        this
      );
    }
    evaluate(e) {
      for (let t of this.steps) if (((e = t(e)), e === ee)) break;
      return e;
    }
  }
  ...
  e.fromNodeEventEmitter = ne;
  function re(e, t, n = (e) => e) {
    let r = (...e) => i.fire(n(...e)),
      i = new N({
  ...
  class se {
    constructor(e, n) {
      ...
      (n || t(r), (this.emitter = new N(r)), n && n.add(this.emitter));
    }
    beginUpdate(e) {
      this._counter++;
    }
  ...
  function ce(e, t) {
    return new se(e, t).emitter.event;
  }
  e.fromObservable = ce;
  function le(e) {
    return (t, n, r) => {
      ...
      return (r instanceof $e ? r.add(s) : Array.isArray(r) && r.push(s), s);
    };
  }
  e.fromObservableLight = le;
})((M ||= {}));
var lt = class e {
  constructor(t) {
  ...
  start(e) {
    ((this._stopWatch = new at()), (this.listenerCount = e));
  }
  stop() {
    if (this._stopWatch) {
...
`),
  ...
  vt = class {
    constructor(e) {
      ((this.value = e), (this.id = _t++));
    }
  },
  yt = 2,
  bt = (e, t) => {
    if (e instanceof vt) t(e);
    else
...
var N = class {
    constructor(e) {
      ((this._size = 0),
        (this._options = e),
        (this._leakageMon =
          dt > 0 || this._options?.leakWarningThreshold
            ? new pt(e?.onListenerError ?? we, this._options?.leakWarningThreshold ?? dt)
            : void 0),
        (this._perfMon = this._options?._profName ? new ut(this._options._profName) : void 0),
        ...
        (this._event ??= (e, t, n) => {
          if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
            ...
            let t = this._leakageMon.getMostFrequentStack() ?? [`UNKNOWN stack`, -1],
              n = new gt(`${e}. HINT: Stack shows most frequent listener (${t[1]}-times)`, t[0]);
            return ((this._options?.onListenerError || we)(n), A.None);
          }
          ...
          (this._leakageMon &&
            ...
            ((r.stack = mt.create()), (i = this._leakageMon.check(r.stack, this._size + 1))),
            st && (r.stack = mt.create()),
            this._listeners
              ? this._listeners instanceof vt
                ? ((this._deliveryQueue ??= new St()), (this._listeners = [this._listeners, r]))
            ...
            this._size++);
          let a = k(() => {
            (xt?.unregister(a), i?.(), this._removeListener(r));
          });
          if ((n instanceof $e ? n.add(a) : Array.isArray(n) && n.push(a), xt)) {
            let e = Error()
                .stack.split(`
`)
                .slice(2, 3)
...
`)
    ...
    _deliver(e, t) {
      if (!e) return;
      let n = this._options?.onListenerError || we;
      if (!n) {
        e.value(t);
        return;
      }
    ...
    fire(e) {
      if (
        ...
        if (this._listeners instanceof vt) this._deliver(this._listeners, e);
        else {
  ...
  Ct = class {
    constructor() {
      ((this.mapWindowIdToZoomLevel = new Map()),
        (this._onDidChangeZoomLevel = new N()),
        (this.onDidChangeZoomLevel = this._onDidChangeZoomLevel.event),
        (this.mapWindowIdToZoomFactor = new Map()),
        (this._onDidChangeFullscreen = new N()),
...
wt.INSTANCE.onDidChangeZoomLevel;
function Et(e) {
  return wt.INSTANCE.getZoomFactor(e);
}
wt.INSTANCE.onDidChangeFullscreen;
var Dt = typeof navigator == `object` ? navigator.userAgent : ``,
  Ot = Dt.indexOf(`Firefox`) >= 0,
  kt = Dt.indexOf(`AppleWebKit`) >= 0,
  At = Dt.indexOf(`Chrome`) >= 0,
  jt = !At && Dt.indexOf(`Safari`) >= 0;
(Dt.indexOf(`Electron/`), Dt.indexOf(`Android`));
var Mt = !1;
if (typeof tt.matchMedia == `function`) {
  let e = tt.matchMedia(`(display-mode: standalone) or (display-mode: window-controls-overlay)`),
    t = tt.matchMedia(`(display-mode: fullscreen)`);
  ((Mt = e.matches),
    Tt(tt, e, ({ matches: e }) => {
      (Mt && t.matches) || (Mt = e);
    }));
...
var Pt = `en`,
  ...
  Ht = globalThis,
  P;
typeof Ht.vscode < `u` && typeof Ht.vscode.process < `u`
  ? (P = Ht.vscode.process)
  : typeof process < `u` && typeof process?.versions?.node == `string` && (P = process);
var Ut = typeof P?.versions?.electron == `string` && P?.type === `renderer`;
if (typeof P == `object`) {
  ((Ft = P.platform === `win32`),
    (It = P.platform === `darwin`),
    (Lt = P.platform === `linux`),
    Lt && P.env.SNAP && P.env.SNAP_REVISION,
    P.env.CI || P.env.BUILD_ARTIFACTSTAGINGDIRECTORY,
    (Bt = Pt));
  let e = P.env.VSCODE_NLS_CONFIG;
  if (e)
    try {
      let t = JSON.parse(e);
      (t.userLocale,
        t.osLocale,
        (Bt = t.resolvedLanguage || Pt),
        t.languagePack?.translationsConfigFile);
    } catch {}
  Rt = !0;
} else
  typeof navigator == `object` && !Ut
    ? ((Vt = navigator.userAgent),
      (Ft = Vt.indexOf(`Windows`) >= 0),
      (It = Vt.indexOf(`Macintosh`) >= 0),
      (Vt.indexOf(`Macintosh`) >= 0 || Vt.indexOf(`iPad`) >= 0 || Vt.indexOf(`iPhone`) >= 0) &&
        navigator.maxTouchPoints &&
        navigator.maxTouchPoints,
      (Lt = Vt.indexOf(`Linux`) >= 0),
      Vt?.indexOf(`Mobi`),
      (zt = !0),
      (Bt = globalThis._VSCODE_NLS_LANGUAGE || Pt),
...
var Wt = Ft,
  ...
  Kt = Lt,
  qt = Rt;
zt && typeof Ht.importScripts == `function` && Ht.origin;
var Jt = Vt,
  Yt = Bt,
  Xt;
((e) => {
...
var Zt = typeof Ht.postMessage == `function` && !Ht.importScripts;
(() => {
  if (Zt) {
    let e = [];
    Ht.addEventListener(`message`, (t) => {
    ...
    return (n) => {
      let r = ++t;
      (e.push({ id: r, callback: n }), Ht.postMessage({ vscodeScheduleAsyncWork: r }, `*`));
    };
  }
  return (e) => setTimeout(e);
})();
var Qt = !!(Jt && Jt.indexOf(`Chrome`) >= 0);
(Jt && Jt.indexOf(`Firefox`),
  !Qt && Jt && Jt.indexOf(`Safari`),
  Jt && Jt.indexOf(`Edg/`),
  Jt && Jt.indexOf(`Android`));
var $t = typeof navigator == `object` ? navigator : {};
(qt ||
  (document.queryCommandSupported && document.queryCommandSupported(`copy`)) ||
  ($t && $t.clipboard && $t.clipboard.writeText),
  qt || ($t && $t.clipboard && $t.clipboard.readText),
  qt || Nt() || $t.keyboard,
  `ontouchstart` in tt || $t.maxTouchPoints,
  tt.PointerEvent && (`ontouchstart` in tt || navigator.maxTouchPoints));
var en = class {
    constructor() {
...
((e) => {
  function t(e) {
    return tn.keyCodeToStr(e);
  }
  e.toString = t;
  function n(e) {
    return tn.strToKeyCode(e);
  }
  e.fromString = n;
  function r(e) {
    return nn.keyCodeToStr(e);
  }
  e.toUserSettingsUS = r;
  function i(e) {
    return rn.keyCodeToStr(e);
  }
  e.toUserSettingsGeneral = i;
  function a(e) {
    return nn.strToKeyCode(e) || rn.strToKeyCode(e);
  }
...
function ln(e) {
  ...
  else if (kt && ((Gt && t === 93) || (!Gt && t === 92))) return 57;
  return an[t] || 0;
}
var un = Gt ? 256 : 2048,
  dn = 512,
    ...
    _computeKeyCodeChord() {
      ...
      return (
        this.keyCode !== 5 &&
          ...
          this.keyCode !== 57 &&
          (e = this.keyCode),
        new sn(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, e)
      );
    }
  },
  hn = new WeakMap();
...
var _n = class {
  ...
  vn = class {
    constructor(e, t) {
      ...
      let n = _n.getPositionOfChildWindowRelativeToAncestorWindow(e, t.view);
...
((e) => {
  function t(t) {
    return t === e.None || t === e.Cancelled || t instanceof Sn
      ? !0
      : !t || typeof t != `object`
        ? !1
  ...
  ((e.isCancellationToken = t),
    (e.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: M.None })),
    (e.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: bn })));
})((xn ||= {}));
var Sn = class {
    constructor() {
    ...
    get onCancellationRequested() {
      return this._isCancelled ? bn : ((this._emitter ||= new N()), this._emitter.event);
    }
    dispose() {
  ...
  Cn = class {
    ...
    cancelAndSet(e, t) {
      if (this._isDisposed) throw new Ae(`Calling 'cancelAndSet' on a disposed TimeoutTimer`);
      (this.cancel(),
    ...
    setIfNotSet(e, t) {
      if (this._isDisposed) throw new Ae(`Calling 'setIfNotSet' on a disposed TimeoutTimer`);
      this._token === -1 &&
        (this._token = setTimeout(() => {
          ((this._token = -1), e());
        }, t));
  ...
  wn = class {
    ...
    cancelAndSet(e, t, n = globalThis) {
      if (this.isDisposed) throw new Ae(`Calling 'cancelAndSet' on a disposed IntervalTimer`);
      this.cancel();
      let r = n.setInterval(() => {
        e();
      }, t);
...
function jn(e, t) {
  switch (typeof e) {
    case `object`:
      return e === null ? Mn(349, t) : Array.isArray(e) ? Fn(e, t) : In(e, t);
    case `string`:
      return Pn(e, t);
    case `boolean`:
      return Nn(e, t);
...
function Nn(e, t) {
  return Mn(e ? 433 : 863, t);
}
function Pn(e, t) {
  t = Mn(149417, t);
  for (let n = 0, r = e.length; n < r; n++) t = Mn(e.charCodeAt(n), t);
  return t;
}
function Fn(e, t) {
  return ((t = Mn(104579, t)), e.reduce((e, t) => jn(t, e), t));
}
function In(e, t) {
  return (
    (t = Mn(181387, t)),
    Object.keys(e)
      .sort()
      .reduce((t, n) => ((t = Pn(n, t)), jn(e[n], t)), t)
  );
}
function Ln(e, t, n = 32) {
  let r = n - t,
    i = ~((1 << r) - 1);
  return ((e << t) | ((i & e) >>> r)) >>> 0;
}
function Rn(e, t = 0, n = e.byteLength, r = 0) {
  ...
  digest() {
    return (
      this._finished ||
        ...
        this._wrapUp()),
      Bn(this._h0) + Bn(this._h1) + Bn(this._h2) + Bn(this._h3) + Bn(this._h4)
    );
  }
  _wrapUp() {
    ((this._buff[this._buffLen++] = 128),
      Rn(this._buff, this._buffLen),
      this._buffLen > 56 && (this._step(), Rn(this._buff)));
  ...
  _step() {
    ...
    for (let e = 0; e < 80; e++)
      (e < 20
        ...
        (u = (Ln(r, 5) + c + s + l + t.getUint32(e * 4, !1)) & 4294967295),
        (s = o),
        (o = a),
        (a = Ln(i, 30)),
        (i = r),
...
var {
    ...
    getWindowById: Jn,
    hasWindow: Yn,
    onDidRegisterWindow: Xn,
    onWillUnregisterWindow: Zn,
    onDidUnregisterWindow: Qn,
  } = (function () {
    let e = new Map(),
      t = { window: tt, disposables: new $e() };
    e.set(tt.vscodeWindowId, t);
    let n = new N(),
      r = new N(),
      i = new N();
    function a(n, r) {
    ...
    return {
      ...
      registerWindow(t) {
        if (e.has(t.vscodeWindowId)) return A.None;
        let a = new $e(),
          o = { window: t, disposables: a.add(new $e()) };
        return (
      ...
      getWindow(e) {
        ...
        let n = e;
        return n?.view ? n.view.window : tt;
      },
      getDocument(e) {
        return Un(e).document;
      },
    };
  })(),
  $n = class {
...
var nr = function (e, t, n, r) {
    ...
    return (
      t === `click` || t === `mousedown` || t === `contextmenu`
        ? (i = er(Un(e), n))
        : (t === `keydown` || t === `keypress` || t === `keyup`) && (i = tr(n)),
      F(e, t, i, r)
    );
  },
  rr,
  ir = class extends wn {
    constructor(e) {
      (super(), (this.defaultTarget = e && Un(e)));
    }
    cancelAndSet(e, t, n) {
  ...
  let e = new Map(),
    ...
    i = (i) => {
      ...
      for (t.set(i, a), e.set(i, []), r.set(i, !0); a.length > 0; )
        (a.sort(ar.sort), a.shift().execute());
      r.set(i, !1);
    };
  rr = (t, r, a = 0) => {
    let o = qn(t),
...
var I = {
    ...
    DROP: `drop`,
    DRAG_END: `dragend`,
    ANIMATION_START: kt ? `webkitAnimationStart` : `animationstart`,
    ANIMATION_END: kt ? `webkitAnimationEnd` : `animationend`,
    ANIMATION_ITERATION: kt ? `webkitAnimationIteration` : `animationiteration`,
  },
  cr = /([\w\-]+)?(#([\w\-]+))?((\.([\w\-]+))*)/;
function lr(e, t, n, ...r) {
  let i = cr.exec(t);
...
function ur(e, t, ...n) {
  return lr(`http://www.w3.org/1999/xhtml`, e, t, ...n);
}
ur.SVG = function (e, t, ...n) {
  return lr(`http://www.w3.org/2000/svg`, e, t, ...n);
};
var dr = class {
  constructor(e) {
    ((this.domNode = e),
  ...
  setTextDecoration(e) {
    this._textDecoration !== e &&
      ((this._textDecoration = e), (this.domNode.style.textDecoration = this._textDecoration));
  }
  setLineHeight(e) {
    let t = L(e);
    this._lineHeight !== t &&
  ...
  setBackgroundColor(e) {
    this._backgroundColor !== e &&
      ((this._backgroundColor = e), (this.domNode.style.backgroundColor = this._backgroundColor));
  }
  setLayerHinting(e) {
    this._layerHint !== e &&
      ((this._layerHint = e),
...
var pr = class {
  constructor() {
    ((this._hooks = new $e()), (this._pointerMoveCallback = null), (this._onStopCallback = null));
  }
  dispose() {
  ...
  startMonitoring(e, t, n, r, i) {
    ...
    (this._hooks.add(
      ...
      this._hooks.add(F(a, I.POINTER_UP, (e) => this.stopMonitoring(!0))));
  }
};
function mr(e, t, n) {
  let r = null,
...
var gr = class e extends A {
      ...
      this._register(
        M.runAndSubscribe(
          ...
          ({ window: e, disposables: t }) => {
            (t.add(F(e.document, `touchstart`, (e) => this.onTouchStart(e), { passive: !1 })),
              t.add(F(e.document, `touchend`, (t) => this.onTouchEnd(e, t))),
              t.add(F(e.document, `touchmove`, (e) => this.onTouchMove(e), { passive: !1 })));
          },
          { window: tt, disposables: this._store },
        ),
      ));
  }
  static addTarget(t) {
    return e.isTouchDevice()
      ? ((e.INSTANCE ||= Ye(new e())), k(e.INSTANCE.targets.push(t)))
      : A.None;
  }
  static ignoreTarget(t) {
    return e.isTouchDevice()
      ? ((e.INSTANCE ||= Ye(new e())), k(e.INSTANCE.ignoreTargets.push(t)))
      : A.None;
  }
  static isTouchDevice() {
    return `ontouchstart` in tt || navigator.maxTouchPoints > 0;
  }
  dispose() {
  ...
  onTouchStart(e) {
    ...
    for (let n = 0, r = e.targetTouches.length; n < r; n++) {
      ...
      let i = this.newGestureEvent(hr.Start, r.target);
  ...
  onTouchEnd(t, n) {
    ...
    for (let a = 0, o = n.changedTouches.length; a < o; a++) {
      ...
      if (
        c < e.HOLD_DELAY &&
        Math.abs(s.initialPageX - O(s.rollingPageX)) < 30 &&
        Math.abs(s.initialPageY - O(s.rollingPageY)) < 30
      ) {
        let e = this.newGestureEvent(hr.Tap, s.initialTarget);
        ((e.pageX = O(s.rollingPageX)), (e.pageY = O(s.rollingPageY)), this.dispatchEvent(e));
      } else if (
        c >= e.HOLD_DELAY &&
        Math.abs(s.initialPageX - O(s.rollingPageX)) < 30 &&
        Math.abs(s.initialPageY - O(s.rollingPageY)) < 30
      ) {
        let e = this.newGestureEvent(hr.Contextmenu, s.initialTarget);
        ((e.pageX = O(s.rollingPageX)), (e.pageY = O(s.rollingPageY)), this.dispatchEvent(e));
      } else if (i === 1) {
        let e = O(s.rollingPageX),
          n = O(s.rollingPageY),
          i = O(s.rollingTimestamps) - s.rollingTimestamps[0],
      ...
      (this.dispatchEvent(this.newGestureEvent(hr.End, s.initialTarget)),
  ...
  dispatchEvent(t) {
    if (t.type === hr.Tap) {
      ...
      ((r = n - this._lastSetTapCountTime > e.CLEAR_TAP_COUNT_TIME ? 1 : 2),
        ...
        (t.tapCount = r));
    } else (t.type === hr.Change || t.type === hr.Contextmenu) && (this._lastSetTapCountTime = 0);
  ...
  inertia(t, n, r, i, a, o, s, c, l) {
    this.handle = rr(t, () => {
      ...
      ((i += e.SCROLL_FRICTION * d),
        ...
        i > 0 && ((m = !1), (f = a * i * d)),
        s > 0 && ((m = !1), (p = c * s * d)));
      let h = this.newGestureEvent(hr.Change);
      ((h.translationX = f),
        (h.translationY = p),
  ...
  onTouchMove(e) {
    ...
    for (let n = 0, r = e.changedTouches.length; n < r; n++) {
      ...
      let i = this.activeTouches[r.identifier],
        a = this.newGestureEvent(hr.Change, i.initialTarget);
      ((a.translationX = r.pageX - O(i.rollingPageX)),
        (a.translationY = r.pageY - O(i.rollingPageY)),
        (a.pageX = r.pageX),
        (a.pageY = r.pageY),
...
((gr.SCROLL_FRICTION = -0.005),
  (gr.HOLD_DELAY = 700),
  (gr.CLEAR_TAP_COUNT_TIME = 400),
  r([mr], gr, `isTouchDevice`, 1));
var _r = gr,
  vr = class extends A {
    onclick(e, t) {
      this._register(F(e, I.CLICK, (n) => t(new vn(Un(e), n))));
    }
    onmousedown(e, t) {
      this._register(F(e, I.MOUSE_DOWN, (n) => t(new vn(Un(e), n))));
    }
    onmouseover(e, t) {
      this._register(F(e, I.MOUSE_OVER, (n) => t(new vn(Un(e), n))));
    }
    onmouseleave(e, t) {
      this._register(F(e, I.MOUSE_LEAVE, (n) => t(new vn(Un(e), n))));
    }
    onkeydown(e, t) {
      this._register(F(e, I.KEY_DOWN, (e) => t(new mn(e))));
    }
    onkeyup(e, t) {
      this._register(F(e, I.KEY_UP, (e) => t(new mn(e))));
    }
    oninput(e, t) {
      this._register(F(e, I.INPUT, t));
    }
    onblur(e, t) {
      this._register(F(e, I.BLUR, t));
    }
    onfocus(e, t) {
      this._register(F(e, I.FOCUS, t));
    }
    onchange(e, t) {
      this._register(F(e, I.CHANGE, t));
    }
    ignoreGesture(e) {
      return _r.ignoreTarget(e);
    }
  },
  yr = 11,
  br = class extends vr {
    constructor(e) {
      (super(),
        ...
        (this.domNode.style.width = yr + `px`),
        (this.domNode.style.height = yr + `px`),
        ...
        (this._pointerMoveMonitor = this._register(new pr())),
        this._register(nr(this.bgDomNode, I.POINTER_DOWN, (e) => this._arrowPointerDown(e))),
        this._register(nr(this.domNode, I.POINTER_DOWN, (e) => this._arrowPointerDown(e))),
        (this._pointerdownRepeatTimer = this._register(new ir())),
        (this._pointerdownScheduleRepeatTimer = this._register(new Cn())));
    }
    _arrowPointerDown(e) {
      !e.target ||
        ...
        this._pointerdownScheduleRepeatTimer.cancelAndSet(() => {
          this._pointerdownRepeatTimer.cancelAndSet(() => this._onActivate(), 1e3 / 24, Un(e));
        }, 200),
  ...
  xr = class e {
    constructor(e, t, n, r, i, a, o) {
      ((this._forceIntegerValues = e),
        ...
        this._forceIntegerValues && ((t |= 0), (n |= 0), (r |= 0), (i |= 0), (a |= 0), (o |= 0)),
  ...
  Sr = class extends A {
    ...
    setScrollPositionSmooth(e, t) {
      ...
      if (this._smoothScrolling) {
        ...
        let t = this._state.withScrollPosition(e);
        this._smoothScrolling = Er.start(this._state, t, this._smoothScrollDuration);
      }
      this._smoothScrolling.animationFrameDisposable = this._scheduleAtNextAnimationFrame(() => {
        this._smoothScrolling &&
          ((this._smoothScrolling.animationFrameDisposable = null), this._performSmoothScrolling());
      });
    }
...
var Er = class e {
  ...
  _initAnimation(e, t, n) {
    if (Math.abs(e - t) > 2.5 * n) {
      let r, i;
      return (
        e < t ? ((r = e + 0.75 * n), (i = t - 0.75 * n)) : ((r = e - 0.75 * n), (i = t + 0.75 * n)),
        Tr(wr(e, r), wr(i, t), 0.33)
      );
    }
    return wr(e, t);
  }
  ...
  _tick(e) {
    ...
    return t < 1
      ? new Cr(this.scrollLeft(t), this.scrollTop(t), !1)
      : new Cr(this.to.scrollLeft, this.to.scrollTop, !0);
  }
  combine(t, n, r) {
...
var kr = class extends A {
    constructor(e, t, n) {
      (super(),
        ...
        (this._revealTimer = this._register(new Cn())));
    }
    setVisibility(e) {
  ...
  jr = class extends vr {
    constructor(e) {
      (super(),
        ...
        (this.domNode = fr(document.createElement(`div`))),
        this.domNode.setAttribute(`role`, `presentation`),
        this.domNode.setAttribute(`aria-hidden`, `true`),
        this._visibilityController.setDomNode(this.domNode),
        this.domNode.setPosition(`absolute`),
        this._register(
          F(this.domNode.domNode, I.POINTER_DOWN, (e) => this._domNodePointerDown(e)),
        ));
    }
    _createArrow(e) {
      let t = this._register(new br(e));
      (this.domNode.domNode.appendChild(t.bgDomNode), this.domNode.domNode.appendChild(t.domNode));
    }
    _createSlider(e, t, n, r) {
      ((this.slider = fr(document.createElement(`div`))),
        ...
        this._register(
          F(this.slider.domNode, I.POINTER_DOWN, (e) => {
  ...
  Mr = class e {
    ...
    getDesiredScrollPositionFromOffsetPaged(e) {
      ...
      return (
        t < this._computedSliderPosition ? (n -= this._visibleSize) : (n += this._visibleSize), n
      );
    }
  ...
  Vr = class extends vr {
    constructor(e, t, n) {
      (super(),
        (this._onScroll = this._register(new N())),
        (this.onScroll = this._onScroll.event),
        (this._onWillScroll = this._register(new N())),
      ...
      ((this._verticalScrollbar = this._register(new Pr(this._scrollable, this._options, r))),
        (this._horizontalScrollbar = this._register(new Nr(this._scrollable, this._options, r))),
        ...
        this._options.useShadows
          ? ((this._leftShadowDomNode = fr(document.createElement(`div`))),
            this._leftShadowDomNode.setClassName(`shadow`),
            this._domNode.appendChild(this._leftShadowDomNode.domNode),
            (this._topShadowDomNode = fr(document.createElement(`div`))),
            this._topShadowDomNode.setClassName(`shadow`),
            this._domNode.appendChild(this._topShadowDomNode.domNode),
            (this._topLeftShadowDomNode = fr(document.createElement(`div`))),
        ...
        (this._hideTimeout = this._register(new Cn())),
        (this._isDragging = !1),
        (this._mouseIsOver = !1),
        (this._shouldRender = !0),
    ...
    updateClassName(e) {
      ((this._options.className = e),
        Gt && (this._options.className += ` mac`),
        (this._domNode.className = `xterm-scrollable-element ` + this._options.className));
    }
    updateOptions(e) {
    ...
    delegateScrollFromMouseWheelEvent(e) {
      this._onMouseWheel(new yn(e));
    }
    _setListeningToMouseWheel(e) {
      this._mouseWheelToDispose.length > 0 !== e &&
        ((this._mouseWheelToDispose = Xe(this._mouseWheelToDispose)), e) &&
    ...
    _onMouseWheel(e) {
      ...
      let t = Br.INSTANCE;
      Lr && t.acceptStandardWheelEvent(e);
      let n = !1;
      if (e.deltaY || e.deltaX) {
        ...
        let a = !Gt && e.browserEvent && e.browserEvent.shiftKey;
        ...
        ((s = this._scrollable.validateScrollPosition(s)),
          (o.scrollLeft !== s.scrollLeft || o.scrollTop !== s.scrollTop) &&
            (Lr && this._options.mouseWheelSmoothScroll && t.isPhysicalMouseWheel()
    ...
    _scheduleHide() {
      !this._mouseIsOver &&
        !this._isDragging &&
        this._hideTimeout.cancelAndSet(() => this._hide(), Fr);
    }
  },
  Hr = class extends Vr {
    constructor(e, t, n) {
...
var Wr = class extends A {
  constructor(e, t, n, r, i, a, o, s) {
    (super(),
      ...
      (this._onRequestScrollLines = this._register(new N())),
    ...
    let c = this._register(
      new Sr({
        ...
        scheduleAtNextAnimationFrame: (e) => rr(r.window, e),
      }),
    );
    (this._register(
      ...
      this._register(
        M.runAndSubscribe(a.onChangeColors, () => {
      ...
      this._register(k(() => this._scrollableElement.getDomNode().remove())),
      (this._styleElement = r.mainDocument.createElement(`style`)),
      t.appendChild(this._styleElement),
      this._register(k(() => this._styleElement.remove())),
      this._register(
        M.runAndSubscribe(a.onChangeColors, () => {
...
Wr = r([i(2, b), i(3, T), i(4, de), i(5, D), i(6, S), i(7, E)], Wr);
var Gr = class extends A {
  constructor(e, t, n, r, i) {
    (super(),
      ...
      this._register(this._decorationService.onDecorationRemoved((e) => this._removeDecoration(e))),
      this._register(
        k(() => {
...
Gr = r([i(1, b), i(2, T), i(3, _e), i(4, E)], Gr);
var Kr = class {
    constructor() {
      ((this._zones = []),
        (this._zonePool = []),
    ...
    get zones() {
      return (
        (this._zonePool.length = Math.min(this._zonePool.length, this._zones.length)), this._zones
      );
    }
    clear() {
      ...
      if (e.options.overviewRulerOptions) {
        for (let t of this._zones)
          if (
            ...
            if (
              this._lineAdjacentToZone(t, e.marker.line, e.options.overviewRulerOptions.position)
            ) {
  ...
  qr = { full: 0, left: 0, center: 0, right: 0 },
  Jr = { full: 0, left: 0, center: 0, right: 0 },
  Yr = { full: 0, left: 0, center: 0, right: 0 },
  Xr = class extends A {
    constructor(e, t, n, r, i, a, o, s) {
      (super(),
        ...
        this._register(k(() => this._canvas?.remove())));
        ...
        this._register(
          this._renderService.onRender(() => {
            (!this._containerHeight ||
              ...
              (this._queueRefresh(!0), (this._containerHeight = this._screenElement.clientHeight));
          }),
        ),
    ...
    _refreshDrawConstants() {
      ...
      ((Jr.full = this._canvas.width),
        ...
        (Yr.left = 1),
        (Yr.center = 1 + Jr.left),
        (Yr.right = 1 + Jr.left + Jr.center));
    }
    _refreshDrawHeightConstants() {
      qr.full = Math.round(2 * this._coreBrowserService.dpr);
      ...
      ((qr.left = t), (qr.center = t), (qr.right = t));
    }
    _refreshColorZonePadding() {
      (this._colorZoneStore.setPadding({
        full: Math.floor(
          (this._bufferService.buffers.active.lines.length / (this._canvas.height - 1)) * qr.full,
        ),
        left: Math.floor(
          (this._bufferService.buffers.active.lines.length / (this._canvas.height - 1)) * qr.left,
        ),
        center: Math.floor(
          (this._bufferService.buffers.active.lines.length / (this._canvas.height - 1)) * qr.center,
        ),
        right: Math.floor(
          (this._bufferService.buffers.active.lines.length / (this._canvas.height - 1)) * qr.right,
        ),
      }),
        (this._lastKnownBufferLength = this._bufferService.buffers.normal.lines.length));
    }
...
Xr = r([i(2, b), i(3, _e), i(4, E), i(5, S), i(6, D), i(7, T)], Xr);
var R;
((e) => (
  (e.NUL = `\0`),
  (e.SOH = ``),
      ...
      if (!this._isComposing) {
        ...
        ((this._dataAlreadySent = n),
          t.length > e.length
            ...
            : t.length < e.length
              ? this._coreService.triggerDataEvent(`${R.DEL}`, !0)
              : t.length === e.length && t !== e && this._coreService.triggerDataEvent(t, !0));
      }
    }, 0);
  }
...
$r = r([i(2, b), i(3, S), i(4, fe), i(5, E)], $r);
var z = 0,
  B = 0,
  V = 0,
  H = 0,
  ei = { css: `#00000000`, rgba: 0 },
  U;
((e) => {
  function t(e, t, n, r) {
    return r === void 0 ? `#${ni(e)}${ni(t)}${ni(n)}` : `#${ni(e)}${ni(t)}${ni(n)}${ni(r)}`;
  }
  e.toCss = t;
...
((e) => {
  function t(e, t) {
    if (((H = (t.rgba & 255) / 255), H === 1)) return { css: t.css, rgba: t.rgba };
    let n = (t.rgba >> 24) & 255,
      r = (t.rgba >> 16) & 255,
      i = (t.rgba >> 8) & 255,
      a = (e.rgba >> 24) & 255,
      ...
      s = (e.rgba >> 8) & 255;
    return (
      (z = a + Math.round((n - a) * H)),
      (B = o + Math.round((r - o) * H)),
      (V = s + Math.round((i - s) * H)),
      { css: U.toCss(z, B, V), rgba: U.toRgba(z, B, V) }
    );
  }
  e.blend = t;
  function n(e) {
  ...
  e.isOpaque = n;
  function r(e, t, n) {
    let r = ti.ensureContrastRatio(e.rgba, t.rgba, n);
    if (r) return U.toColor((r >> 24) & 255, (r >> 16) & 255, (r >> 8) & 255);
  }
  e.ensureContrastRatio = r;
  function i(e) {
    let t = (e.rgba | 255) >>> 0;
    return (([z, B, V] = ti.toChannels(t)), { css: U.toCss(z, B, V), rgba: t });
  }
  e.opaque = i;
  function a(e, t) {
    return (
      (H = Math.round(t * 255)),
      ([z, B, V] = ti.toChannels(e.rgba)),
      { css: U.toCss(z, B, V, H), rgba: U.toRgba(z, B, V, H) }
    );
  }
  e.opacity = a;
  function o(e, t) {
  ...
  function r(e) {
    if (e.match(/#[\da-f]{3,8}/i))
      switch (e.length) {
        case 4:
          return (
            (z = parseInt(e.slice(1, 2).repeat(2), 16)),
            (B = parseInt(e.slice(2, 3).repeat(2), 16)),
            (V = parseInt(e.slice(3, 4).repeat(2), 16)),
            U.toColor(z, B, V)
          );
        case 5:
          return (
            ...
            (B = parseInt(e.slice(2, 3).repeat(2), 16)),
            (V = parseInt(e.slice(3, 4).repeat(2), 16)),
            (H = parseInt(e.slice(4, 5).repeat(2), 16)),
            U.toColor(z, B, V, H)
          );
        case 7:
    ...
    if (r)
      return (
        ...
        (B = parseInt(r[2])),
        (V = parseInt(r[3])),
        (H = Math.round((r[5] === void 0 ? 1 : parseFloat(r[5])) * 255)),
        U.toColor(z, B, V, H)
      );
    if (
      !t ||
      ...
      (t.fillRect(0, 0, 1, 1), ([z, B, V, H] = t.getImageData(0, 0, 1, 1).data), H !== 255)
    )
      throw Error(`css.toColor: Unsupported css format`);
    return { rgba: U.toRgba(z, B, V, H), css: e };
  }
  e.toColor = r;
})((G ||= {}));
var K;
...
((e) => {
  ...
  e.blend = t;
  function n(e, t, n) {
    let a = K.relativeLuminance(e >> 8),
      o = K.relativeLuminance(t >> 8);
    if (ri(a, o) < n) {
      if (o < a) {
        let o = r(e, t, n),
          s = ri(a, K.relativeLuminance(o >> 8));
        if (s < n) {
          let r = i(e, t, n);
          return s > ri(a, K.relativeLuminance(r >> 8)) ? o : r;
        }
        return o;
      }
      let s = i(e, t, n),
        c = ri(a, K.relativeLuminance(s >> 8));
      if (c < n) {
        let i = r(e, t, n);
        return c > ri(a, K.relativeLuminance(i >> 8)) ? s : i;
      }
      return s;
    }
  }
  ...
  function r(e, t, n) {
    let r = (e >> 24) & 255,
      ...
      s = (t >> 16) & 255,
      c = (t >> 8) & 255,
      l = ri(K.relativeLuminance2(o, s, c), K.relativeLuminance2(r, i, a));
    for (; l < n && (o > 0 || s > 0 || c > 0); )
    ...
    getJoinedCharacters(e) {
      ...
      for (let e = 0; e < t.getTrimmedLength(); e++)
        if ((t.loadCell(e, this._workCell), this._workCell.getWidth() !== 0)) {
          ...
          a += this._workCell.getChars().length || re.length;
        }
    ...
    _getJoinedRanges(e, t, n, r, i) {
      ...
      for (let e = 1; e < this._characterJoiners.length; e++)
        try {
          ...
          for (let e = 0; e < t.length; e++) ai._mergeRanges(o, t[e]);
        } catch (e) {
          console.error(e);
        }
    ...
    _stringRangesToCellRanges(e, t, n) {
      ...
      if (o) {
        for (let s = n; s < this._bufferService.cols; s++) {
          let n = t.getWidth(s),
            c = t.getString(s).length || re.length;
          if (n !== 0) {
...
function li() {
  return {
    css: { canvas: ui(), cell: ui() },
    device: { canvas: ui(), cell: ui(), char: { width: 0, height: 0, left: 0, top: 0 } },
  };
}
function ui() {
...
var di = class {
  ...
  createRow(e, t, n, r, i, a, o, s, c, l, u) {
    ...
    for (let b = 0; b < m; b++) {
      ...
      let de = !1,
        ...
        pe = b,
        x = this._workCell;
      if (f.length > 0 && b === f[0][0] && fe) {
        let r = f.shift(),
          i = this._isCellInSelection(r[0], t);
        for (ee = r[0] + 1; ee < r[1]; ee++) fe &&= i === this._isCellInSelection(ee, t);
        ((fe &&= !n || a < r[0] || a >= r[1]),
          fe
            ? ((de = !0),
              (x = new ii(this._workCell, e.translateToString(!0, r[0], r[1]), r[1] - r[0])),
              (pe = r[1] - 1),
              (m = x.getWidth()))
            : (le = r[1]));
      }
      let me = this._isCellInSelection(b, t),
        S = n && b === a,
        he = ue && b >= l && b <= u,
        ge = !1;
      ...
      let _e = x.getChars() || re;
      if (
        (_e === ` ` && (x.isUnderline() || x.isOverline()) && (_e = `\xA0`),
        (ce = m * s - c.get(_e, x.isBold(), x.isItalic())),
        !h)
      )
        ...
        g &&
        ((me && se) || (!me && !se && x.bg === te)) &&
        ((me && se && p.selectionForeground) || x.fg === ne) &&
        x.extended.ext === ae &&
        he === v &&
        ce === oe &&
        !S &&
        ...
        (x.isInvisible() ? (_ += re) : (_ += _e), g++);
        continue;
      } else
        (g && (h.textContent = _), (h = this._document.createElement(`span`)), (g = 0), (_ = ``));
      if (
        ((te = x.bg),
        (ne = x.fg),
        (ae = x.extended.ext),
        ...
        (se = me),
        de && a >= b && a <= pe && (a = b),
        !this._coreService.isCursorHidden && S && this._coreService.isCursorInitialized)
      ) {
        if ((y.push(`xterm-cursor`), this._coreBrowserService.isFocused))
          (o && y.push(`xterm-cursor-blink`),
            y.push(
              r === `bar`
                ? `xterm-cursor-bar`
                : r === `underline`
      ...
      if (
        (x.isBold() && y.push(`xterm-bold`),
        x.isItalic() && y.push(`xterm-italic`),
        x.isDim() && y.push(`xterm-dim`),
        (_ = x.isInvisible() ? re : x.getChars() || re),
        x.isUnderline() &&
          (y.push(`xterm-underline-${x.extended.underlineStyle}`),
          _ === ` ` && (_ = `\xA0`),
          !x.isUnderlineColorDefault()))
      )
        if (x.isUnderlineColorRGB())
          h.style.textDecorationColor = `rgb(${ie.toColorRGB(x.getUnderlineColor()).join(`,`)})`;
        else {
          let e = x.getUnderlineColor();
      ...
      (x.isOverline() && (y.push(`xterm-overline`), _ === ` ` && (_ = `\xA0`)),
        x.isStrikethrough() && y.push(`xterm-strikethrough`),
        he && (h.style.textDecoration = `underline`));
      let C = x.getFgColor(),
        ve = x.getFgColorMode(),
        w = x.getBgColor(),
        T = x.getBgColorMode(),
      ...
      let E,
        ...
        xe = !1;
      (this._decorationService.forEachDecorationAtCell(b, t, void 0, (e) => {
        (e.options.layer !== `top` && xe) ||
          (e.backgroundColorRGB &&
            ((T = 50331648),
            (w = (e.backgroundColorRGB.rgba >> 8) & 16777215),
            (E = e.backgroundColorRGB)),
          e.foregroundColorRGB &&
            ((ve = 50331648),
            (C = (e.foregroundColorRGB.rgba >> 8) & 16777215),
            (be = e.foregroundColorRGB)),
          (xe = e.options.layer === `top`));
      }),
        !xe &&
          me &&
          ((E = this._coreBrowserService.isFocused
          ...
          p.selectionForeground &&
            ((ve = 50331648),
            (C = (p.selectionForeground.rgba >> 8) & 16777215),
            (be = p.selectionForeground))),
        xe && y.push(`xterm-decoration-top`));
      let D;
      switch (T) {
        case 16777216:
        case 33554432:
          ((D = p.ansi[w]), y.push(`xterm-bg-${w}`));
          break;
        case 50331648:
          ((D = U.toColor(w >> 16, (w >> 8) & 255, w & 255)),
            this._addStyle(h, `background-color:#${fi((w >>> 0).toString(16), `0`, 6)}`));
          break;
        default:
          ye ? ((D = p.foreground), y.push(`xterm-bg-257`)) : (D = p.background);
      }
      switch ((E || (x.isDim() && (E = W.multiplyOpacity(D, 0.5))), ve)) {
        case 16777216:
        case 33554432:
          (x.isBold() &&
            C < 8 &&
            this._optionsService.rawOptions.drawBoldTextInBrightColors &&
            (C += 8),
            this._applyMinimumContrast(h, D, p.ansi[C], x, E, void 0) || y.push(`xterm-fg-${C}`));
          break;
        case 50331648:
          let e = U.toColor((C >> 16) & 255, (C >> 8) & 255, C & 255);
          this._applyMinimumContrast(h, D, e, x, E, be) ||
            this._addStyle(h, `color:#${fi(C.toString(16), `0`, 6)}`);
          break;
        default:
          this._applyMinimumContrast(h, D, p.foreground, x, E, be) ||
            (ye && y.push(`xterm-fg-257`));
      }
      ((y.length &&= ((h.className = y.join(` `)), 0)),
        !S && !de && !ge && fe ? g++ : (h.textContent = _),
        ce !== this.defaultSpacing && (h.style.letterSpacing = `${ce}px`),
        d.push(h),
        (b = pe));
    }
  ...
  _applyMinimumContrast(e, t, n, r, i, a) {
    if (this._optionsService.rawOptions.minimumContrastRatio === 1 || ci(r.getCode())) return !1;
    ...
    if ((!i && !a && (s = o.getColor(t.rgba, n.rgba)), s === void 0)) {
      ...
      ((s = W.ensureContrastRatio(i || t, a || n, e)),
...
di = r([i(1, xe), i(2, S), i(3, T), i(4, fe), i(5, _e), i(6, D)], di);
function fi(e, t, n) {
...
var pi = class {
    ...
    setFont(e, t, n, r) {
      (e === this._font && t === this._fontSize && n === this._weight && r === this._weightBold) ||
        ((this._font = e),
        (this._fontSize = t),
        (this._weight = n),
        (this._weightBold = r),
...
var gi = `xterm-dom-renderer-owner-`,
  _i = `xterm-rows`,
  vi = `xterm-fg-`,
  yi = `xterm-bg-`,
  bi = `xterm-focus`,
  ...
  Ci = class extends A {
    constructor(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
      (super(),
        ...
        (this._terminalClass = Si++),
        (this._rowElements = []),
        (this._selectionRenderModel = hi()),
        (this.onRequestRedraw = this._register(new N()).event),
        (this._rowContainer = this._document.createElement(`div`)),
        this._rowContainer.classList.add(_i),
        (this._rowContainer.style.lineHeight = `normal`),
        this._rowContainer.setAttribute(`aria-hidden`, `true`),
        this._refreshRowElements(this._bufferService.cols, this._bufferService.rows),
        (this._selectionContainer = this._document.createElement(`div`)),
        this._selectionContainer.classList.add(xi),
        ...
        (this._rowFactory = s.createInstance(di, document)),
        this._element.classList.add(gi + this._terminalClass),
        ...
        this._register(
          k(() => {
            (this._element.classList.remove(gi + this._terminalClass),
        ...
        (this._widthCache = new pi(this._document, this._helperContainer)),
    ...
    _updateDimensions() {
      ...
      let t = `${this._terminalSelector} .${_i} span { display: inline-block; height: 100%; vertical-align: top;}`;
    ...
    _injectCss(e) {
      ...
      let t = `${this._terminalSelector} .${_i} { pointer-events: none; color: ${e.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
      ((t += `${this._terminalSelector} .${_i} .xterm-dim { color: ${W.multiplyOpacity(e.foreground, 0.5).css};}`),
      ...
      ((t += `@keyframes ${n} { 50% {  border-bottom-style: hidden; }}`),
        ...
        (t += `${this._terminalSelector} .${_i}.${bi} .xterm-cursor.xterm-cursor-blink.xterm-cursor-underline { animation: ${n} 1s step-end infinite;}${this._terminalSelector} .${_i}.${bi} .xterm-cursor.xterm-cursor-blink.xterm-cursor-bar { animation: ${r} 1s step-end infinite;}${this._terminalSelector} .${_i}.${bi} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: ${i} 1s step-end infinite;}${this._terminalSelector} .${_i} .xterm-cursor.xterm-cursor-block { background-color: ${e.cursor.css}; color: ${e.cursorAccent.css};}${this._terminalSelector} .${_i} .xterm-cursor.xterm-cursor-block:not(.xterm-cursor-blink) { background-color: ${e.cursor.css} !important; color: ${e.cursorAccent.css} !important;}${this._terminalSelector} .${_i} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${e.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${_i} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${e.cursor.css} inset;}${this._terminalSelector} .${_i} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${e.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`),
        (t += `${this._terminalSelector} .${xi} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${xi} div { position: absolute; background-color: ${e.selectionBackgroundOpaque.css};}${this._terminalSelector} .${xi} div { position: absolute; background-color: ${e.selectionInactiveBackgroundOpaque.css};}`));
      for (let [n, r] of e.ansi.entries())
        t += `${this._terminalSelector} .${vi}${n} { color: ${r.css}; }${this._terminalSelector} .${vi}${n}.xterm-dim { color: ${W.multiplyOpacity(r, 0.5).css}; }${this._terminalSelector} .${yi}${n} { background-color: ${r.css}; }`;
      ((t += `${this._terminalSelector} .${vi}257 { color: ${W.opaque(e.background).css}; }${this._terminalSelector} .${vi}257.xterm-dim { color: ${W.multiplyOpacity(W.opaque(e.background), 0.5).css}; }${this._terminalSelector} .${yi}257 { background-color: ${e.foreground.css}; }`),
    ...
    handleBlur() {
      (this._rowContainer.classList.remove(bi), this.renderRows(0, this._bufferService.rows - 1));
    }
    handleFocus() {
      (this._rowContainer.classList.add(bi),
...
Ci = r([i(7, x), i(8, w), i(9, S), i(10, b), i(11, fe), i(12, T), i(13, D)], Ci);
var wi = class extends A {
  constructor(e, t, n) {
    (super(),
      (this._optionsService = n),
      (this.width = 0),
      (this.height = 0),
      (this._onCharSizeChange = this._register(new N())),
      (this.onCharSizeChange = this._onCharSizeChange.event));
    try {
      this._measureStrategy = this._register(new Di(this._optionsService));
    } catch {
      this._measureStrategy = this._register(new Ei(e, t, this._optionsService));
    }
    this._register(
...
var Ti = class extends A {
  ...
  Oi = class extends A {
    constructor(e, t, n) {
      (super(),
        ...
        (this._screenDprMonitor = this._register(new ki(this._window))),
        (this._onDprChange = this._register(new N())),
        (this.onDprChange = this._onDprChange.event),
        (this._onWindowChange = this._register(new N())),
        (this.onWindowChange = this._onWindowChange.event),
        this._register(this.onWindowChange((e) => this._screenDprMonitor.setWindow(e))),
        this._register(M.forward(this._screenDprMonitor.onDprChange, this._onDprChange)),
        this._register(F(this._textarea, `focus`, () => (this._isFocused = !0))),
        this._register(F(this._textarea, `blur`, () => (this._isFocused = !1))));
    }
    get window() {
      return this._window;
    }
  ...
  ki = class extends A {
    constructor(e) {
      (super(),
        ...
        (this._windowResizeListener = this._register(new et())),
        (this._onDprChange = this._register(new N())),
        (this.onDprChange = this._onDprChange.event),
        ...
        this._register(k(() => this.clearListener())));
    }
    setWindow(e) {
      ((this._parentWindow = e), this._setWindowResizeListener(), this._setDprAndFireIfDiffers());
    }
    _setWindowResizeListener() {
      this._windowResizeListener.value = F(this._parentWindow, `resize`, () =>
  ...
  Ai = class extends A {
    constructor() {
      (super(),
        (this.linkProviders = []),
        this._register(k(() => (this.linkProviders.length = 0))));
    }
...
function Mi(e, t, n, r, i, a, o, s, c) {
  ...
  if (l)
    return (
      ...
      (l[1] = Math.ceil(l[1] / s)),
      (l[0] = Math.min(Math.max(l[0], 1), r + +!!c)),
...
var Ni = class {
  ...
  getMouseReportCoords(e, t) {
    ...
    if (this._charSizeService.hasValidSize)
      return (
        (n[0] = Math.min(Math.max(n[0], 0), this._renderService.dimensions.css.canvas.width - 1)),
        (n[1] = Math.min(Math.max(n[1], 0), this._renderService.dimensions.css.canvas.height - 1)),
        {
...
var Ii = typeof process < `u` && `title` in process,
...
var Ui = [`Macintosh`, `MacIntel`, `MacPPC`, `Mac68K`].includes(Ri),
  Wi = Ri === `iPad`,
  Gi = Ri === `iPhone`,
  Ki = [`Windows`, `Win16`, `Win32`, `WinCE`].includes(Ri),
  qi = Ri.indexOf(`Linux`) >= 0,
  Ji = /\bCrOS\b/.test(Li),
  Yi = class {
    constructor() {
  ...
  Qi = !Ii && `requestIdleCallback` in window ? Zi : Xi,
  $i = class {
    constructor() {
      this._queue = new Qi();
    }
  ...
  ea = class extends A {
    constructor(e, t, n, r, i, a, o, s, c) {
      (super(),
        ...
        (this._coreService = i),
        (this._coreBrowserService = s),
        (this._renderer = this._register(new et())),
        (this._pausedResizeTask = new $i()),
        (this._observerDisposable = this._register(new et())),
        (this._isPaused = !1),
        ...
        (this._onDimensionsChange = this._register(new N())),
        (this.onDimensionsChange = this._onDimensionsChange.event),
        (this._onRenderedViewportChange = this._register(new N())),
        (this.onRenderedViewportChange = this._onRenderedViewportChange.event),
        (this._onRender = this._register(new N())),
        (this.onRender = this._onRender.event),
        (this._onRefreshRequest = this._register(new N())),
        (this.onRefreshRequest = this._onRefreshRequest.event),
        (this._renderDebouncer = new Pi(
          (e, t) => this._renderRows(e, t),
          this._coreBrowserService,
        )),
        this._register(this._renderDebouncer),
        (this._syncOutputHandler = new ta(this._coreBrowserService, this._coreService, () =>
          this._fullRefresh(),
        )),
        this._register(k(() => this._syncOutputHandler.dispose())),
        this._register(
        ...
        this._register(
          this._coreBrowserService.onWindowChange((e) => this._registerIntersectionObserver(e, t)),
        ));
    }
    get dimensions() {
    ...
    _registerIntersectionObserver(e, t) {
      if (`IntersectionObserver` in e) {
        let n = new e.IntersectionObserver((e) => this._handleIntersectionChange(e[e.length - 1]), {
          threshold: 0,
        });
        (n.observe(t), (this._observerDisposable.value = k(() => n.disconnect())));
      }
    }
      ...
      if (this._renderer.value) {
        ...
        ((e = Math.min(e, this._rowCount - 1)),
          ...
          (this._needsSelectionRefresh &&=
            ...
            !1)),
          this._isNextRenderRedrawOnly || this._onRenderedViewportChange.fire({ start: e, end: t }),
...
ea = r([i(2, S), i(3, w), i(4, fe), i(5, _e), i(6, b), i(7, T), i(8, D)], ea);
var ta = class {
  constructor(e, t, n) {
...
function na(e, t, n, r) {
  let i = n.buffer.x,
    a = n.buffer.y;
  if (!n.buffer.hasScrollback) return aa(i, a, e, t, n, r) + oa(a, t, n, r) + sa(i, a, e, t, n, r);
  let o;
  if (a === t) return ((o = i > e ? `D` : `C`), ma(Math.abs(i - e), pa(o, r)));
  o = a > t ? `D` : `C`;
  let s = Math.abs(a - t);
  return ma(ia(a > t ? e : i, n) + (s - 1) * n.cols + 1 + ra(a > t ? i : e, n), pa(o, r));
}
function ra(e, t) {
  return e - 1;
}
...
function aa(e, t, n, r, i, a) {
  return oa(t, r, i, a).length === 0 ? `` : ma(fa(e, t, e, t - la(t, i), !1, i).length, pa(`D`, a));
}
function oa(e, t, n, r) {
  let i = e - la(e, n),
    a = t - la(t, n);
  return ma(Math.abs(i - a) - ca(e, t, n), pa(da(e, t), r));
}
function sa(e, t, n, r, i, a) {
  let o;
  o = oa(t, r, i, a).length > 0 ? r - la(r, i) : t;
  let s = r,
    c = ua(e, t, n, r, i, a);
  return ma(fa(e, o, n, s, c === `C`, i).length, pa(c, a));
}
function ca(e, t, n) {
  let r = 0,
    i = e - la(e, n),
...
function ua(e, t, n, r, i, a) {
  let o;
  return (
    (o = oa(n, r, i, a).length > 0 ? r - la(r, i) : t),
    (e < n && o <= r) || (e >= n && o < r) ? `C` : `D`
  );
}
function da(e, t) {
  ...
  handleTrim(e) {
    return (
      ...
      this.selectionEnd && this.selectionEnd[1] < 0
        ...
        : (this.selectionStart && this.selectionStart[1] < 0 && (this.selectionStart[1] = 0), !1)
    );
  }
};
function ga(e, t) {
  ...
  Sa = class extends A {
    constructor(e, t, n, r, i, a, o, s, c) {
      (super(),
        ...
        (this._onLinuxMouseSelection = this._register(new N())),
        (this.onLinuxMouseSelection = this._onLinuxMouseSelection.event),
        (this._onRedrawRequest = this._register(new N())),
        (this.onRequestRedraw = this._onRedrawRequest.event),
        (this._onSelectionChange = this._register(new N())),
        ...
        (this._trimListener = this._bufferService.buffer.lines.onTrim((e) => this._handleTrim(e))),
        this._register(
          this._bufferService.buffers.onBufferActivate((e) => this._handleBufferActivate(e)),
        ),
        this.enable(),
        (this._model = new ha(this._bufferService)),
...
`,
    ...
    _selectWordAtCursor(e, t) {
      ...
      if (n)
        return (
          ...
          (this._model.selectionStartLength = ga(n, this._bufferService.cols)),
    ...
    _getMouseEventScrollAmount(e) {
      let t = ji(this._coreBrowserService.window, e, this._screenElement)[1],
        n = this._renderService.dimensions.css.canvas.height;
      return t >= 0 && t <= n
        ? 0
        : (t > n && (t -= n),
          (t = Math.min(Math.max(t, -_a), _a)),
          (t /= _a),
          t / Math.abs(t) + Math.round(t * (va - 1)));
    }
    ...
    shouldColumnSelect(e) {
      return e.altKey && !(Ui && this._optionsService.rawOptions.macOptionClickForcesSelection);
    }
    _handleMouseMove(e) {
    ...
    rightClickSelect(e) {
      this._isClickInSelection(e) ||
        (this._selectWordAtCursor(e, !1) && this.refresh(!0), this._fireEventIfSelectionChanged());
    }
    ...
    _selectLineAt(e) {
      let t = this._bufferService.buffer.getWrappedRangeForLine(e),
        n = { start: { x: 0, y: t.first }, end: { x: this._bufferService.cols - 1, y: t.last } };
      ((this._model.selectionStart = [0, t.first]),
        (this._model.selectionEnd = void 0),
        (this._model.selectionStartLength = ga(n, this._bufferService.cols)));
    }
  };
Sa = r([i(3, b), i(4, fe), i(5, ye), i(6, S), i(7, E), i(8, T)], Sa);
var Ca = class {
    constructor() {
      this._data = {};
    }
  ...
  wa = class {
    constructor() {
      ((this._color = new Ca()), (this._css = new Ca()));
    }
    setCss(e, t, n) {
      this._css.set(e, t, n);
    }
    ...
    (() => {
      ...
      for (let n = 0; n < 216; n++) {
        let r = t[((n / 36) % 6) | 0],
          i = t[((n / 6) % 6) | 0],
          a = t[n % 6];
        e.push({ css: U.toCss(r, i, a), rgba: U.toRgba(r, i, a) });
      }
      for (let t = 0; t < 24; t++) {
        let n = 8 + t * 10;
        e.push({ css: U.toCss(n, n, n), rgba: U.toRgba(n, n, n) });
      }
      return e;
    })(),
  ),
  ...
  Da = G.toColor(`#ffffff`),
  Oa = Ea,
  ka = { css: `rgba(255, 255, 255, 0.3)`, rgba: 4294967117 },
  Aa = Ta,
  ja = class extends A {
    constructor(e) {
      (super(),
        (this._optionsService = e),
        (this._contrastCache = new wa()),
        (this._halfContrastCache = new wa()),
        (this._onChangeColors = this._register(new N())),
        ...
        (this._colors = {
          ...
          selectionBackgroundTransparent: ka,
          selectionBackgroundOpaque: W.blend(Ea, ka),
          selectionInactiveBackgroundTransparent: ka,
          selectionInactiveBackgroundOpaque: W.blend(Ea, ka),
          scrollbarSliderBackground: W.opacity(Ta, 0.2),
          scrollbarSliderHoverBackground: W.opacity(Ta, 0.4),
          scrollbarSliderActiveBackground: W.opacity(Ta, 0.5),
          overviewRulerBorder: Ta,
          ansi: q.slice(),
    ...
    _setTheme(e = {}) {
      let t = this._colors;
      if (
        ((t.foreground = J(e.foreground, Ta)),
        (t.background = J(e.background, Ea)),
        (t.cursor = W.blend(t.background, J(e.cursor, Da))),
        (t.cursorAccent = W.blend(t.background, J(e.cursorAccent, Oa))),
        (t.selectionBackgroundTransparent = J(e.selectionBackground, ka)),
        (t.selectionBackgroundOpaque = W.blend(t.background, t.selectionBackgroundTransparent)),
        (t.selectionInactiveBackgroundTransparent = J(
          e.selectionInactiveBackground,
          t.selectionBackgroundTransparent,
        )),
        (t.selectionInactiveBackgroundOpaque = W.blend(
          t.background,
          t.selectionInactiveBackgroundTransparent,
        )),
        (t.selectionForeground = e.selectionForeground ? J(e.selectionForeground, ei) : void 0),
        t.selectionForeground === ei && (t.selectionForeground = void 0),
        W.isOpaque(t.selectionBackgroundTransparent) &&
          (t.selectionBackgroundTransparent = W.opacity(t.selectionBackgroundTransparent, 0.3)),
        W.isOpaque(t.selectionInactiveBackgroundTransparent) &&
          (t.selectionInactiveBackgroundTransparent = W.opacity(
            t.selectionInactiveBackgroundTransparent,
            0.3,
          )),
        (t.scrollbarSliderBackground = J(
          e.scrollbarSliderBackground,
          W.opacity(t.foreground, 0.2),
        )),
        (t.scrollbarSliderHoverBackground = J(
          e.scrollbarSliderHoverBackground,
          W.opacity(t.foreground, 0.4),
        )),
        (t.scrollbarSliderActiveBackground = J(
          e.scrollbarSliderActiveBackground,
          W.opacity(t.foreground, 0.5),
        )),
        (t.overviewRulerBorder = J(e.overviewRulerBorder, Aa)),
        (t.ansi = q.slice()),
        ...
        for (let r = 0; r < n; r++) t.ansi[r + 16] = J(e.extendedAnsi[r], q[r + 16]);
      }
      (this._contrastCache.clear(),
...
var Ma = class {
  ...
  Na = class {
    constructor() {
      ((this._services = new Ma()), this._services.set(x, this));
    }
    setService(e, t) {
    ...
    createInstance(e, ...t) {
      let n = le(e).sort((e, t) => e.index - t.index),
        r = [];
      for (let t of n) {
  ...
  Pa = { trace: 0, debug: 1, info: 2, warn: 3, error: 4, off: 5 },
  Fa = `xterm.js: `,
  Ia = class extends A {
    constructor(e) {
      (super(),
    ...
    _updateLogLevel() {
      this._logLevel = Pa[this._optionsService.rawOptions.logLevel];
    }
    ...
    _log(e, t, n) {
      (this._evalLazyOptionalParams(n),
        e.call(console, (this._optionsService.options.logger ? `` : Fa) + t, ...n));
    }
    trace(e, ...t) {
      this._logLevel <= 0 &&
        this._log(
...
var La,
  Ra = class extends A {
    constructor(e) {
      (super(),
        (this._maxLength = e),
        (this.onDeleteEmitter = this._register(new N())),
        (this.onDelete = this.onDeleteEmitter.event),
        (this.onInsertEmitter = this._register(new N())),
        (this.onInsert = this.onInsertEmitter.event),
        (this.onTrimEmitter = this._register(new N())),
  ...
  Va = class e {
    constructor(e, t, n = !1) {
      ...
      let r = t || v.fromCharData([0, ne, 1, 0]);
    ...
    get(e) {
      ...
      return [
        this._data[e * Y + 1],
        t & 2097152 ? this._combined[e] : n ? g(n) : ``,
        t >> 22,
    ...
    set(e, t) {
      ((this._data[e * Y + 1] = t[0]),
        t[1].length > 1
          ? ((this._combined[e] = t[1]), (this._data[e * Y + 0] = e | 2097152 | (t[2] << 22)))
    ...
    getString(e) {
      let t = this._data[e * Y + 0];
      return t & 2097152 ? this._combined[e] : t & 2097151 ? g(t & 2097151) : ``;
    }
    isProtected(e) {
    ...
    loadCell(e, t) {
      return (
        (za = e * Y),
        (t.content = this._data[za + 0]),
        (t.fg = this._data[za + 1]),
        (t.bg = this._data[za + 2]),
    ...
    addCodepointToCell(e, t, n) {
      ...
      (r & 2097152
        ? (this._combined[e] += g(t))
        : r & 2097151
          ? ((this._combined[e] = g(r & 2097151) + g(t)), (r &= -2097152), (r |= 2097152))
          : (r = t | (1 << 22)),
        n && ((r &= -12582913), (r |= n << 22)),
        (this._data[e * Y + 0] = r));
    }
    ...
    replaceCells(e, t, n, r = !1) {
      ...
      for (
        e && this.getWidth(e - 1) === 2 && this.setCellFromCodepoint(e - 1, 0, 1, n),
          t < this.length && this.getWidth(t - 1) === 2 && this.setCellFromCodepoint(t, 0, 1, n);
        e < t && e < this.length;
      )
        this.setCell(e++, n);
    }
    resize(e, t) {
      if (e === this.length) return this._data.length * 4 * Ba < this._data.buffer.byteLength;
      let n = e * Y;
      if (e > this.length) {
      ...
      return ((this.length = e), n * 4 * Ba < this._data.buffer.byteLength);
    }
    cleanupMemory() {
      if (this._data.length * 4 * Ba < this._data.buffer.byteLength) {
    ...
    copyFrom(e) {
      (this.length === e.length ? this._data.set(e._data) : (this._data = new Uint32Array(e._data)),
    ...
    getTrimmedLength() {
      for (let e = this.length - 1; e >= 0; --e)
        if (this._data[e * Y + 0] & 4194303) return e + (this._data[e * Y + 0] >> 22);
      return 0;
    }
    ...
    copyCellsFrom(e, t, n, r, i) {
      ...
      if (i)
        for (let i = r - 1; i >= 0; i--) {
          for (let e = 0; e < Y; e++) this._data[(n + i) * Y + e] = a[(t + i) * Y + e];
          a[(t + i) * Y + 2] & 268435456 && (this._extendedAttrs[n + i] = e._extendedAttrs[t + i]);
        }
      else
        for (let i = 0; i < r; i++) {
          for (let e = 0; e < Y; e++) this._data[(n + i) * Y + e] = a[(t + i) * Y + e];
    ...
    translateToString(e, t, n, r) {
      ...
      for (; t < n; ) {
        let e = this._data[t * Y + 0],
          n = e & 2097151,
          a = e & 2097152 ? this._combined[t] : n ? g(n) : re;
...
function Ga(e, t, n) {
  let r = [],
    i = e.map((n, r) => Ka(e, r, t)).reduce((e, t) => e + t),
    a = 0,
    o = 0,
    s = 0;
  for (; s < i; ) {
...
var qa = class e {
  constructor(t) {
    ((this.line = t),
      ...
      (this._disposables = []),
      (this._id = e._nextId++),
      (this._onDispose = this.register(new N())),
  ...
  Za = class {
    constructor(e, t, n) {
      ((this._hasScrollback = e),
        ...
        (this.savedCharset = Ya),
        (this.markers = []),
        (this._nullCell = v.fromCharData([0, ne, 1, 0])),
        (this._whitespaceCell = v.fromCharData([0, re, 1, 32])),
        (this._isClearing = !1),
        (this._memoryCleanupQueue = new Qi()),
        (this._memoryCleanupPosition = 0),
        (this._cols = this._bufferService.cols),
        (this._rows = this._bufferService.rows),
        (this.lines = new Ra(this._getCorrectBufferLength(this._rows))),
        (this.scrollTop = 0),
    ...
    getNullCell(e) {
      return (
        e
          ...
          : ((this._nullCell.fg = 0),
            (this._nullCell.bg = 0),
            (this._nullCell.extended = new ae())),
        this._nullCell
      );
    }
    getWhitespaceCell(e) {
      return (
        e
          ...
          : ((this._whitespaceCell.fg = 0),
            ...
            (this._whitespaceCell.extended = new ae())),
        this._whitespaceCell
      );
    }
    getBlankLine(e, t) {
      return new Va(this._bufferService.cols, this.getNullCell(e), t);
    }
    get hasScrollback() {
    ...
    resize(e, t) {
      ...
      if (
        ((this.scrollBottom = t - 1), this._isReflowEnabled && (this._reflow(e, t), this._cols > e))
      )
        for (let t = 0; t < this.lines.length; t++) r += +this.lines.get(t).resize(e, n);
      ((this._cols = e),
        (this._rows = t),
    ...
    _reflowLarger(e, t) {
      let n = this._optionsService.rawOptions.reflowCursorLine,
        r = Ha(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(X), n);
      if (r.length > 0) {
        let n = Ua(this.lines, r);
        (Wa(this.lines, n.layout), this._reflowLargerAdjustViewport(e, t, n.countRemoved));
      }
    }
    _reflowLargerAdjustViewport(e, t, n) {
      ...
      for (; i-- > 0; )
        this.ybase === 0
          ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new Va(e, r)))
      ...
      for (let o = this.lines.length - 1; o >= 0; o--) {
        ...
        for (; g >= 0; ) {
          ...
          (c[m].copyCellsFrom(c[g], _ - e, h - e, e, !0),
            ...
            h === 0 && (m--, (h = u[m])),
            (_ -= e),
            _ === 0 && (g--, (_ = Ka(c, Math.max(g, 0), this._cols))));
        }
  ...
  Qa = class extends A {
    constructor(e, t) {
      (super(),
        (this._optionsService = e),
        (this._bufferService = t),
        (this._onBufferActivate = this._register(new N())),
    ...
    reset() {
      ((this._normal = new Za(!0, this._optionsService, this._bufferService)),
        this._normal.fillViewportRows(),
        (this._alt = new Za(!1, this._optionsService, this._bufferService)),
  ...
  to = class extends A {
    constructor(e) {
      (super(),
        ...
        (this._onResize = this._register(new N())),
        (this.onResize = this._onResize.event),
        (this._onScroll = this._register(new N())),
        (this.onScroll = this._onScroll.event),
        (this.cols = Math.max(e.rawOptions.cols || 0, $a)),
        (this.rows = Math.max(e.rawOptions.rows || 0, eo)),
        (this.buffers = this._register(new Qa(e, this))),
        this._register(
...
var no = {
  ...
  ro = [`normal`, `bold`, `100`, `200`, `300`, `400`, `500`, `600`, `700`, `800`, `900`],
  io = class extends A {
    constructor(e) {
      (super(),
        (this._onOptionChange = this._register(new N())),
    ...
    _setupOptions() {
      let e = (e) => {
          if (!(e in no)) throw Error(`No option with key "${e}"`);
          return this.rawOptions[e];
        },
        t = (e, t) => {
          if (!(e in no)) throw Error(`No option with key "${e}"`);
          ((t = this._sanitizeAndValidateOption(e, t)),
            this.rawOptions[e] !== t && ((this.rawOptions[e] = t), this._onOptionChange.fire(e)));
        };
    ...
    _sanitizeAndValidateOption(e, t) {
      switch (e) {
        case `cursorStyle`:
          if (((t ||= no[e]), !ao(t))) throw Error(`"${t}" is not a valid value for ${e}`);
          break;
        case `wordSeparator`:
          t ||= no[e];
          break;
...
function oo(e, t = 5) {
  ...
  for (let r in e) n[r] = t <= 1 ? e[r] : e[r] && oo(e[r], t - 1);
  return n;
}
var so = Object.freeze({ insertMode: !1 }),
  co = Object.freeze({
  ...
  lo = class extends A {
    constructor(e, t, n) {
      (super(),
        ...
        (this._onData = this._register(new N())),
        (this.onData = this._onData.event),
        (this._onUserInput = this._register(new N())),
        (this.onUserInput = this._onUserInput.event),
        (this._onBinary = this._register(new N())),
        (this.onBinary = this._onBinary.event),
        (this._onRequestScrollToBottom = this._register(new N())),
        (this.onRequestScrollToBottom = this._onRequestScrollToBottom.event),
        (this.modes = oo(so)),
        (this.decPrivateModes = oo(co)));
    }
    reset() {
      ((this.modes = oo(so)), (this.decPrivateModes = oo(co)));
    }
...
lo = r([i(0, b), i(1, me), i(2, S)], lo);
var uo = {
  NONE: { events: 0, restrict: () => !1 },
  X10: {
    events: 1,
    restrict: (e) =>
      e.button === 4 || e.action !== 1 ? !1 : ((e.ctrl = !1), (e.alt = !1), (e.shift = !1), !0),
  },
...
var po = String.fromCharCode,
  mo = {
    DEFAULT: (e) => {
      let t = [fo(e, !1) + 32, e.col + 32, e.row + 32];
      return t[0] > 255 || t[1] > 255 || t[2] > 255
        ? ``
        : `\x1B[M${po(t[0])}${po(t[1])}${po(t[2])}`;
    },
    SGR: (e) => {
      let t = e.action === 0 && e.button !== 4 ? `m` : `M`;
      return `\x1B[<${fo(e, !0)};${e.col};${e.row}${t}`;
    },
    SGR_PIXELS: (e) => {
      let t = e.action === 0 && e.button !== 4 ? `m` : `M`;
      return `\x1B[<${fo(e, !0)};${e.x};${e.y}${t}`;
    },
  },
  ho = class extends A {
    constructor(e, t, n) {
      (super(),
        ...
        (this._onProtocolChange = this._register(new N())),
        (this.onProtocolChange = this._onProtocolChange.event));
      for (let e of Object.keys(uo)) this.addProtocol(e, uo[e]);
      for (let e of Object.keys(mo)) this.addEncoding(e, mo[e]);
      this.reset();
    }
    addProtocol(e, t) {
      this._protocols[e] = t;
...
var yo = class {
    constructor() {
      if (((this.version = `6`), !Q)) {
        ...
        for (let e = 0; e < go.length; ++e) Q.fill(0, go[e][0], go[e][1] + 1);
      }
    }
    wcwidth(e) {
      return e < 32
    ...
    charProperties(e, t) {
      let n = this.wcwidth(e),
        r = n === 0 && t !== 0;
      if (r) {
        let e = bo.extractWidth(t);
        e === 0 ? (r = !1) : e > n && (n = e);
      }
      return bo.createPropertyValue(0, n, r);
    }
  },
  bo = class e {
    constructor() {
...
var Co = 2147483647,
  ...
  To = class e {
    constructor(e = 32, t = 32) {
      if (((this.maxLength = e), (this.maxSubParamsLength = t), t > wo))
    ...
    addParam(e) {
      ...
      ((this._subParamsIdx[this.length] = (this._subParamsLength << 8) | this._subParamsLength),
        (this.params[this.length++] = e > Co ? Co : e));
    }
    addSubParam(e) {
      if (((this._digitIsSub = !0), this.length)) {
        ...
        if (e < -1) throw Error(`values lesser than -1 are not allowed`);
        ((this._subParams[this._subParamsLength++] = e > Co ? Co : e),
  ...
  Do = class {
    ...
    dispose() {
      ((this._handlers = Object.create(null)), (this._handlerFb = () => {}), (this._active = Eo));
    }
    reset() {
      if (this._state === 2)
        for (
      ...
      ((this._stack.paused = !1), (this._active = Eo), (this._id = -1), (this._state = 0));
    }
    _start() {
      if (((this._active = this._handlers[this._id] || Eo), !this._active.length))
        this._handlerFb(this._id, `START`);
      else for (let e = this._active.length - 1; e >= 0; e--) this._active[e].start();
    }
    _put(e, t, n) {
      if (!this._active.length) this._handlerFb(this._id, `PUT`, _(e, t, n));
    ...
    put(e, t, n) {
      ...
      if (this._state !== 0) {
        ...
        ((this._active = Eo), (this._id = -1), (this._state = 0));
      }
    }
  },
  Oo = class {
  ...
  Ao = class {
    ...
    dispose() {
      ((this._handlers = Object.create(null)), (this._handlerFb = () => {}), (this._active = ko));
    }
    registerHandler(e, t) {
      this._handlers[e] === void 0 && (this._handlers[e] = []);
      let n = this._handlers[e];
    ...
    reset() {
      ...
      ((this._stack.paused = !1), (this._active = ko), (this._ident = 0));
    }
    hook(e, t) {
      if (
        (this.reset(),
        (this._ident = e),
        (this._active = this._handlers[e] || ko),
        !this._active.length)
      )
    ...
    put(e, t, n) {
      if (!this._active.length) this._handlerFb(this._ident, `PUT`, _(e, t, n));
      else for (let r = this._active.length - 1; r >= 0; r--) this._active[r].put(e, t, n);
    }
    unhook(e, t = !0) {
...
var Mo = class {
    constructor(e) {
      ((this._handler = e), (this._data = ``), (this._params = jo), (this._hitLimit = !1));
    }
    hook(e) {
      ((this._params = e.length > 1 || e.params[0] ? e.clone() : jo),
        (this._data = ``),
        (this._hitLimit = !1));
    }
    put(e, t, n) {
    ...
    unhook(e) {
      ...
      if (this._hitLimit) t = !1;
        ...
        return t.then((e) => ((this._params = jo), (this._data = ``), (this._hitLimit = !1), e));
      return ((this._params = jo), (this._data = ``), (this._hitLimit = !1), t);
    }
  },
  No = class {
    constructor(e) {
  ...
  Io = class extends A {
    constructor(e = Fo) {
      (super(),
        ...
        (this._oscParser = this._register(new Do())),
        (this._dcsParser = this._register(new Ao())),
    ...
    parse(e, t, n) {
      ...
      for (let n = a; n < t; ++n) {
        switch (
          ((r = e[n]),
          (i = this._transitions.table[(this.currentState << 8) | (r < 160 ? r : Po)]),
          i >> 4)
        ) {
          case 2:
            for (let i = n + 1; ; ++i) {
              if (i >= t || (r = e[i]) < 32 || (r > 126 && r < Po)) {
          ...
          case 13:
            for (let i = n + 1; ; ++i)
              if (i >= t || (r = e[i]) === 24 || r === 26 || r === 27 || (r > 127 && r < Po)) {
...
function zo(e) {
  ...
  if (t.indexOf(`rgb:`) === 0) {
    ...
    t.indexOf(`#`) === 0 &&
    ((t = t.slice(1)), Ro.exec(t) && [3, 6, 9, 12].includes(t.length))
  ) {
    let e = t.length / 3,
      n = [0, 0, 0];
    for (let r = 0; r < 3; ++r) {
...
function Vo(e, t = 16) {
  let [n, r, i] = e;
  return `rgb:${Bo(n, t)}/${Bo(r, t)}/${Bo(i, t)}`;
}
var Ho = { "(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2 },
  Uo = 131072,
  Wo = 10;
...
var Ko = 5e3,
  qo = 0,
  Jo = class extends A {
    constructor(e, t, n, r, i, a, o, s, c = new Io()) {
      (super(),
        (this._bufferService = e),
        ...
        (this._stringDecoder = new ee()),
        (this._utf8Decoder = new te()),
        (this._windowTitle = ``),
        (this._iconName = ``),
        ...
        (this._dirtyRowTracker = new Yo(this._bufferService)),
        ...
        this._parser.registerCsiHandler({ final: `b` }, (e) => this.repeatPrecedingCharacter(e)),
        this._parser.registerCsiHandler({ final: `c` }, (e) => this.sendDeviceAttributesPrimary(e)),
        ...
        this._parser.registerCsiHandler({ prefix: `?`, final: `h` }, (e) => this.setModePrivate(e)),
        ...
        this._parser.setExecuteHandler(R.BEL, () => this.bell()),
        this._parser.setExecuteHandler(R.LF, () => this.lineFeed()),
        this._parser.setExecuteHandler(R.VT, () => this.lineFeed()),
        this._parser.setExecuteHandler(R.FF, () => this.lineFeed()),
        this._parser.setExecuteHandler(R.CR, () => this.carriageReturn()),
        this._parser.setExecuteHandler(R.BS, () => this.backspace()),
        this._parser.setExecuteHandler(R.HT, () => this.tab()),
        this._parser.setExecuteHandler(R.SO, () => this.shiftOut()),
        this._parser.setExecuteHandler(R.SI, () => this.shiftIn()),
        this._parser.setExecuteHandler(Zr.IND, () => this.index()),
        this._parser.setExecuteHandler(Zr.NEL, () => this.nextLine()),
        this._parser.setExecuteHandler(Zr.HTS, () => this.tabSet()),
        this._parser.registerOscHandler(
          0,
          new Oo((e) => (this.setTitle(e), this.setIconName(e), !0)),
        ),
        this._parser.registerOscHandler(1, new Oo((e) => this.setIconName(e))),
        this._parser.registerOscHandler(2, new Oo((e) => this.setTitle(e))),
        this._parser.registerOscHandler(4, new Oo((e) => this.setOrReportIndexedColor(e))),
        this._parser.registerOscHandler(8, new Oo((e) => this.setHyperlink(e))),
        this._parser.registerOscHandler(10, new Oo((e) => this.setOrReportFgColor(e))),
        this._parser.registerOscHandler(11, new Oo((e) => this.setOrReportBgColor(e))),
        this._parser.registerOscHandler(12, new Oo((e) => this.setOrReportCursorColor(e))),
        this._parser.registerOscHandler(104, new Oo((e) => this.restoreIndexedColor(e))),
        this._parser.registerOscHandler(110, new Oo((e) => this.restoreFgColor(e))),
        this._parser.registerOscHandler(111, new Oo((e) => this.restoreBgColor(e))),
        this._parser.registerOscHandler(112, new Oo((e) => this.restoreCursorColor(e))),
      ...
      (this._parser.registerEscHandler({ intermediates: `#`, final: `8` }, () =>
        ...
        this._parser.registerDcsHandler(
          ...
          new Mo((e, t) => this.requestStatusString(e, t)),
        ));
    }
    getAttrData() {
    ...
    _logSlowResolvingAsync(e) {
      this._logService.logLevel <= 3 &&
        Promise.race([e, new Promise((e, t) => setTimeout(() => t(`#SLOW_TIMEOUT`), Ko))]).catch(
          (e) => {
            if (e !== `#SLOW_TIMEOUT`) throw e;
            console.warn(`async parser handler taking longer than ${Ko} ms`);
          },
        );
    }
    _getCurrentLinkId() {
    ...
    parse(e, t) {
      ...
      if (o) {
        ...
        ((r = this._parseStack.cursorStartX),
          ...
          e.length > Uo && (a = this._parseStack.position + Uo));
      }
      if (
        ...
        this._parseBuffer.length < e.length &&
          this._parseBuffer.length < Uo &&
          (this._parseBuffer = new Uint32Array(Math.min(e.length, Uo))),
        o || this._dirtyRowTracker.clearRange(),
        e.length > Uo)
      )
        for (let t = a; t < e.length; t += Uo) {
          let a = t + Uo < e.length ? t + Uo : e.length,
            o =
              typeof e == `string`
    ...
    print(e, t, n) {
      ...
      for (let p = t; p < n; ++p) {
        ...
        i = bo.extractWidth(t);
        let n = bo.extractShouldJoin(t),
          m = n ? bo.extractWidth(f) : 0;
        if (
          ((f = t),
          o && this._onA11yChar.fire(g(r)),
          ...
          if (c) {
            ...
            for (
              this._activeBuffer.x = m,
                ...
                d = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y),
                m > 0 && d instanceof Va && d.copyCellsFrom(e, t, 0, m, !1);
              t < s;
            )
    ...
    registerCsiHandler(e, t) {
      return e.final === `t` && !e.prefix && !e.intermediates
        ? this._parser.registerCsiHandler(e, (e) =>
            Go(e.params[0], this._optionsService.rawOptions.windowOptions) ? t(e) : !0,
          )
        : this._parser.registerCsiHandler(e, t);
    }
    registerDcsHandler(e, t) {
      return this._parser.registerDcsHandler(e, new Mo(t));
    }
    registerEscHandler(e, t) {
      return this._parser.registerEscHandler(e, t);
    }
    registerOscHandler(e, t) {
      return this._parser.registerOscHandler(e, new Oo(t));
    }
    bell() {
    ...
    _setCursor(e, t) {
      (this._dirtyRowTracker.markDirty(this._activeBuffer.y),
        this._coreService.decPrivateModes.origin
          ? ((this._activeBuffer.x = e), (this._activeBuffer.y = this._activeBuffer.scrollTop + t))
      ...
      return (
        e.params[0] > 0 ||
          (this._is(`xterm`) || this._is(`rxvt-unicode`) || this._is(`screen`)
            ? this._coreService.triggerDataEvent(R.ESC + `[?1;2c`)
            : this._is(`linux`) && this._coreService.triggerDataEvent(R.ESC + `[?6c`)),
        !0
      );
    }
    sendDeviceAttributesSecondary(e) {
      return (
        e.params[0] > 0 ||
          (this._is(`xterm`)
            ? this._coreService.triggerDataEvent(R.ESC + `[>0;276;0c`)
            : this._is(`rxvt-unicode`)
              ? this._coreService.triggerDataEvent(R.ESC + `[>85;95;0c`)
              : this._is(`linux`)
                ? this._coreService.triggerDataEvent(e.params[0] + `c`)
                : this._is(`screen`) &&
                  this._coreService.triggerDataEvent(R.ESC + `[>83;40003;0c`)),
        !0
      );
    }
    _is(e) {
      ...
      for (let t = 0; t < e.length; t++)
        switch (e.params[t]) {
          case 1:
            ...
            break;
          case 2:
            (this._charsetService.setgCharset(0, Ya),
              this._charsetService.setgCharset(1, Ya),
              this._charsetService.setgCharset(2, Ya),
              this._charsetService.setgCharset(3, Ya));
            break;
          case 3:
    ...
    requestMode(e, t) {
      ...
      let r = this._coreService.decPrivateModes,
        ...
        f = (e, n) => (o.triggerDataEvent(`${R.ESC}[${t ? `` : `?`}${e};${n}$y`), !0),
        p = (e) => (e ? 1 : 2),
        m = e.params[0];
      return t
        ? m === 2
        ...
        : m === 1
          ...
          : m === 3
            ? f(m, d.windowOptions.setWinLines ? (c === 80 ? 2 : +(c === 132)) : 0)
            : m === 6
              ? f(m, p(r.origin))
              : m === 7
                ? f(m, p(r.wraparound))
    ...
    _updateAttrColor(e, t, n, r, i) {
      return (
        t === 2
          ? ((e |= 50331648), (e &= -16777216), (e |= ie.fromColorRGB([n, r, i])))
                  ...
                  : n === 0
                    ...
                    : n === 1
                      ...
                      : n === 3
                        ...
                        : n === 4
                          ? ((r.fg |= 268435456),
                            this._processUnderline(e.hasSubParams(i) ? e.getSubParams(i)[0] : 1, r))
                          : n === 5
                            ? (r.fg |= 536870912)
                            : n === 7
                              ? (r.fg |= 67108864)
                                    ...
                                    : n === 21
                                      ...
                                      : n === 22
                                        ...
                                        : n === 23
                                          ? (r.bg &= -67108865)
                                          : n === 24
                                            ? ((r.fg &= -268435457), this._processUnderline(0, r))
                                            : n === 25
                                              ? (r.fg &= -536870913)
                                              : n === 27
                                                ? (r.fg &= -67108865)
    ...
    windowOptions(e) {
      if (!Go(e.params[0], this._optionsService.rawOptions.windowOptions)) return !0;
        ...
        case 18:
          this._bufferService &&
            this._coreService.triggerDataEvent(
              `${R.ESC}[8;${this._bufferService.rows};${this._bufferService.cols}t`,
            );
          break;
        case 22:
          ((t === 0 || t === 2) &&
            (this._windowTitleStack.push(this._windowTitle),
            this._windowTitleStack.length > Wo && this._windowTitleStack.shift()),
            (t === 0 || t === 1) &&
              (this._iconNameStack.push(this._iconName),
              this._iconNameStack.length > Wo && this._iconNameStack.shift()));
          break;
        case 23:
          ((t === 0 || t === 2) &&
    ...
    _createHyperlink(e, t) {
      ...
      return (
        ...
        (this._curAttrData.extended.urlId = this._oscLinkService.registerLink({ id: r, uri: t })),
    ...
    selectDefaultCharset() {
      return (this._charsetService.setgLevel(0), this._charsetService.setgCharset(0, Ya), !0);
    }
    selectCharset(e) {
      return e.length === 2
        ? (e[0] === `/` || this._charsetService.setgCharset(Ho[e[0]], Z[e[1]] || Ya), !0)
    ...
    requestStatusString(e, t) {
      let n = (e) => (this._coreService.triggerDataEvent(`${R.ESC}${e}${R.ESC}\\`), !0),
          ...
          : e === `"p`
            ...
            : e === `r`
              ...
              : e === `m`
                ? `P1$r0m`
                : e === ` q`
                  ? `P1$r${{ block: 2, underline: 4, bar: 6 }[i.cursorStyle] - +!!i.cursorBlink} q`
                  : `P0$r`,
      );
    }
    markRangeDirty(e, t) {
  ...
  es = class extends A {
    constructor(e) {
      (super(),
        ...
        (this._onWriteParsed = this._register(new N())),
  ...
  ts = class {
    ...
    registerLink(e) {
      ...
      if (e.id === void 0) {
        ...
        return (
          n.onDispose(() => this._removeMarkerFromLink(r, n)), this._dataByLinkId.set(r.id, r), r.id
        );
      }
      let n = e,
...
var ns = !1,
  rs = class extends A {
    constructor(e) {
      (super(),
        (this._windowsWrappingHeuristics = this._register(new et())),
        (this._onBinary = this._register(new N())),
        (this.onBinary = this._onBinary.event),
        (this._onData = this._register(new N())),
        (this.onData = this._onData.event),
        ...
        (this.onWriteParsed = this._onWriteParsed.event),
        (this._onScroll = this._register(new N())),
        (this._instantiationService = new Na()),
        (this.optionsService = this._register(new io(e))),
        this._instantiationService.setService(S, this.optionsService),
        (this._bufferService = this._register(this._instantiationService.createInstance(to))),
        this._instantiationService.setService(b, this._bufferService),
        (this._logService = this._register(this._instantiationService.createInstance(Ia))),
        this._instantiationService.setService(me, this._logService),
        (this.coreService = this._register(this._instantiationService.createInstance(lo))),
        this._instantiationService.setService(fe, this.coreService),
        (this.coreMouseService = this._register(this._instantiationService.createInstance(ho))),
        this._instantiationService.setService(de, this.coreMouseService),
        (this.unicodeService = this._register(this._instantiationService.createInstance(bo))),
        this._instantiationService.setService(ge, this.unicodeService),
        (this._charsetService = this._instantiationService.createInstance(xo)),
        this._instantiationService.setService(pe, this._charsetService),
        (this._oscLinkService = this._instantiationService.createInstance(ts)),
        this._instantiationService.setService(he, this._oscLinkService),
        ...
        this._register(M.forward(this._inputHandler.onLineFeed, this._onLineFeed)),
        this._register(this._inputHandler),
        this._register(M.forward(this._bufferService.onResize, this._onResize)),
        this._register(M.forward(this.coreService.onData, this._onData)),
        this._register(M.forward(this.coreService.onBinary, this._onBinary)),
        ...
        (this._writeBuffer = this._register(new es((e, t) => this._inputHandler.parse(e, t)))),
        this._register(M.forward(this._writeBuffer.onWriteParsed, this._onWriteParsed)));
    }
    get onScroll() {
      return (
        this._onScrollApi ||
          ((this._onScrollApi = this._register(new N())),
    ...
    writeSync(e, t) {
      (this._logService.logLevel <= 3 &&
        !ns &&
        (this._logService.warn(`writeSync is unreliable and will be removed soon.`), (ns = !0)),
    ...
    resize(e, t) {
      isNaN(e) ||
        isNaN(t) ||
        ((e = Math.max(e, $a)), (t = Math.max(t, eo)), this._bufferService.resize(e, t));
    }
    scroll(e, t = !1) {
    ...
    _enableWindowsWrappingHeuristics() {
      if (!this._windowsWrappingHeuristics.value) {
        let e = [];
        (e.push(this.onLineFeed(So.bind(null, this._bufferService))),
          e.push(this.registerCsiHandler({ final: `H` }, () => (So(this._bufferService), !1))),
          (this._windowsWrappingHeuristics.value = k(() => {
        ...
        : e.key === `UIKeyInputLeftArrow`
          ...
          : e.key === `UIKeyInputRightArrow`
            ...
            : e.key === `UIKeyInputDownArrow` &&
              (t ? (i.key = R.ESC + `OB`) : (i.key = R.ESC + `[B`));
      break;
    case 8:
      ...
      if (e.ctrlKey && !e.shiftKey && !e.altKey && !e.metaKey)
            ...
            : e.keyCode >= 51 && e.keyCode <= 55
              ...
              : e.keyCode === 56
                ...
                : e.keyCode === 219
                  ...
                  : e.keyCode === 220
                    ? (i.key = R.FS)
                    : e.keyCode === 221 && (i.key = R.GS);
      else if ((!n || r) && e.altKey && !e.metaKey) {
        let t = is[e.keyCode]?.[+!!e.shiftKey];
        if (t) i.key = R.ESC + t;
        ...
        n && !e.altKey && !e.ctrlKey && !e.shiftKey && e.metaKey
          ...
          : e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && e.key.length === 1
            ...
            : e.key &&
              e.ctrlKey &&
              (e.key === `_` && (i.key = R.US), e.key === `@` && (i.key = R.NUL));
      break;
  }
  return i;
}
var $ = 0,
  os = class {
    constructor(e) {
      ((this._getKey = e),
        ...
        (this._flushInsertedTask = new Qi()),
        (this._isFlushingInserted = !1),
        (this._deletedIndices = []),
        (this._flushDeletedTask = new Qi()),
    ...
    delete(e) {
      ...
      if (t === void 0 || (($ = this._search(t)), $ === -1) || this._getKey(this._array[$]) !== t)
        return !1;
      do
        if (this._array[$] === e)
          return (
    ...
    *getKeyIterator(e) {
      if (
        ...
        this._array.length !== 0 &&
          (($ = this._search(e)),
          !($ < 0 || $ >= this._array.length) && this._getKey(this._array[$]) === e))
      )
  ...
  ls = class extends A {
    constructor() {
      (super(),
        (this._decorations = new os((e) => e?.marker.line)),
        (this._onDecorationRegistered = this._register(new N())),
        (this.onDecorationRegistered = this._onDecorationRegistered.event),
        (this._onDecorationRemoved = this._register(new N())),
        (this.onDecorationRemoved = this._onDecorationRemoved.event),
        this._register(k(() => this.reset())));
    }
    get decorations() {
    ...
    *getDecorationsAtCell(e, t, n) {
    ...
    forEachDecorationAtCell(e, t, n, r) {
      this._decorations.forEachByKey(t, (t) => {
        ((ss = t.options.x ?? 0),
          (cs = ss + (t.options.width ?? 1)),
          e >= ss && e < cs && (!n || (t.options.layer ?? `bottom`) === n) && r(t));
      });
    }
  },
  us = class extends $e {
    constructor(e) {
      (super(),
        (this.options = e),
        (this.onRenderEmitter = this.add(new N())),
        (this.onRender = this.onRenderEmitter.event),
        (this._onDispose = this.add(new N())),
        (this.onDispose = this._onDispose.event),
        (this._cachedBg = null),
        (this._cachedFg = null),
      ...
      return (
        this._cachedBg === null &&
          (this.options.backgroundColor
            ? (this._cachedBg = G.toColor(this.options.backgroundColor))
  ...
  hs = class extends A {
    constructor(e, t, n, r) {
      ...
      if (
        ...
        (this._liveRegionDebouncer = this._register(new fs(this._renderRows.bind(this)))),
...
`),
        ...
        this._register(
          k(() => {
            (ms ? this._debugRootContainer.remove() : this._accessibilityContainer.remove(),
    ...
    _handleChar(e) {
      this._liveRegionLineCount < ps + 1 &&
...
` &&
          ...
          this._liveRegionLineCount === ps + 1 && (this._liveRegion.textContent += c.get())));
    }
    _clearLiveRegion() {
...
hs = r([i(1, x), i(2, T), i(3, E)], hs);
var gs = class extends A {
  constructor(e, t, n, r, i) {
    (super(),
      (this._element = e),
      ...
      (this._wasResized = !1),
      (this._activeLine = -1),
      (this._onShowLinkUnderline = this._register(new N())),
      (this.onShowLinkUnderline = this._onShowLinkUnderline.event),
      (this._onHideLinkUnderline = this._register(new N())),
      (this.onHideLinkUnderline = this._onHideLinkUnderline.event),
      this._register(
        k(() => {
          (Xe(this._linkCacheDisposables),
      ...
      this._register(
        F(this._element, `mouseleave`, () => {
          ((this._isMouseOut = !0), this._clearCurrentLink());
        }),
      ),
      this._register(F(this._element, `mousemove`, this._handleMouseMove.bind(this))),
      this._register(F(this._element, `mousedown`, this._handleMouseDown.bind(this))),
      this._register(F(this._element, `mouseup`, this._handleMouseUp.bind(this))));
  }
  get currentLink() {
  ...
  _handleMouseMove(e) {
    ...
    (!this._lastBufferCell || t.x !== this._lastBufferCell.x || t.y !== this._lastBufferCell.y) &&
  ...
  _checkLinkProviderResult(e, t, n) {
    ...
    if (this._activeProviderReplies.size === this._linkProviderService.linkProviders.length && !n)
  ...
  _handleMouseUp(e) {
    ...
    t &&
      this._mouseDownLink &&
      _s(this._mouseDownLink.link, this._currentLink.link) &&
  ...
  _clearCurrentLink(e, t) {
    !this._currentLink ||
      ...
      ((!e ||
        !t ||
        (this._currentLink.link.range.start.y >= e && this._currentLink.link.range.end.y <= t)) &&
...
gs = r([i(1, ye), i(2, E), i(3, b), i(4, Se)], gs);
function _s(e, t) {
  return (
    e.text === t.text &&
...
var vs = class extends rs {
  constructor(e = {}) {
    (super(e),
      (this._linkifier = this._register(new et())),
      (this.browser = Fi),
      (this._keyDownHandled = !1),
      (this._keyDownSeen = !1),
      (this._keyPressHandled = !1),
      (this._unprocessedDeadKey = !1),
      (this._accessibilityManager = this._register(new et())),
      (this._onCursorMove = this._register(new N())),
      (this.onCursorMove = this._onCursorMove.event),
      (this._onKey = this._register(new N())),
      ...
      (this._onTitleChange = this._register(new N())),
      (this.onTitleChange = this._onTitleChange.event),
      (this._onBell = this._register(new N())),
      (this.onBell = this._onBell.event),
      (this._onFocus = this._register(new N())),
      (this._onBlur = this._register(new N())),
      (this._onA11yCharEmitter = this._register(new N())),
      (this._onA11yTabEmitter = this._register(new N())),
      (this._onWillOpen = this._register(new N())),
      this._setup(),
      (this._decorationService = this._instantiationService.createInstance(ls)),
      this._instantiationService.setService(_e, this._decorationService),
      (this._linkProviderService = this._instantiationService.createInstance(Ai)),
      this._instantiationService.setService(Se, this._linkProviderService),
      this._linkProviderService.registerLinkProvider(this._instantiationService.createInstance(C)),
      ...
      this._register(
        this._inputHandler.onRequestWindowsOptionsReport((e) => this._reportWindowsOptions(e)),
      ),
      this._register(this._inputHandler.onColor((e) => this._handleColorEvent(e))),
      this._register(M.forward(this._inputHandler.onCursorMove, this._onCursorMove)),
      this._register(M.forward(this._inputHandler.onTitleChange, this._onTitleChange)),
      this._register(M.forward(this._inputHandler.onA11yChar, this._onA11yCharEmitter)),
      this._register(M.forward(this._inputHandler.onA11yTab, this._onA11yTabEmitter)),
    ...
    if (this._themeService)
      for (let t of e) {
        ...
        switch (t.type) {
          case 0:
            let r = W.toColorRGB(
              e === `ansi` ? this._themeService.colors.ansi[t.index] : this._themeService.colors[e],
            );
            this.coreService.triggerDataEvent(`${R.ESC}]${n};${Vo(r)}${Qr.ST}`);
            break;
          case 1:
            if (e === `ansi`)
              this._themeService.modifyColors((e) => (e.ansi[t.index] = U.toColor(...t.color)));
            else {
              let n = e;
  ...
  _handleScreenReaderModeOptionChange(e) {
    e
      ? !this._accessibilityManager.value &&
        this._renderService &&
        (this._accessibilityManager.value = this._instantiationService.createInstance(hs, this))
      : this._accessibilityManager.clear();
  }
  _handleTextAreaFocus(e) {
    (this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(R.ESC + `[I`),
  ...
  _handleTextAreaBlur() {
    ((this.textarea.value = ``),
      ...
      this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(R.ESC + `[O`),
  ...
  _initGlobal() {
    (this._bindKeys(),
      this._register(
        F(this.element, `copy`, (e) => {
          this.hasSelection() && d(e, this._selectionService);
        }),
      ));
    let e = (e) => f(e, this.textarea, this.coreService, this.optionsService);
    (this._register(F(this.textarea, `paste`, e)),
      this._register(F(this.element, `paste`, e)),
      zi
        ? this._register(
            F(this.element, `mousedown`, (e) => {
              e.button === 2 &&
                h(
                  e,
                  this.textarea,
      ...
      qi &&
        this._register(
          F(this.element, `auxclick`, (e) => {
            e.button === 1 && m(e, this.textarea, this.screenElement);
          }),
        ));
  }
  _bindKeys() {
    (this._register(F(this.textarea, `keyup`, (e) => this._keyUp(e), !0)),
      this._register(F(this.textarea, `keydown`, (e) => this._keyDown(e), !0)),
      this._register(F(this.textarea, `keypress`, (e) => this._keyPress(e), !0)),
      this._register(
        F(this.textarea, `compositionstart`, () => this._compositionHelper.compositionstart()),
      ),
      this._register(
        F(this.textarea, `compositionupdate`, (e) => this._compositionHelper.compositionupdate(e)),
      ),
      this._register(
        F(this.textarea, `compositionend`, () => this._compositionHelper.compositionend()),
      ),
      this._register(F(this.textarea, `input`, (e) => this._inputEvent(e), !0)),
  ...
  open(e) {
    ...
    ((this._viewportElement = this._document.createElement(`div`)),
      ...
      this._register(F(this.screenElement, `mousemove`, (e) => this.updateCursorStyle(e))),
    ...
    (this.textarea.classList.add(`xterm-helper-textarea`),
      this.textarea.setAttribute(`aria-label`, o.get()),
      Ji || this.textarea.setAttribute(`aria-multiline`, `false`),
      ...
      this._register(F(this.textarea, `focus`, (e) => this._handleTextAreaFocus(e))),
      this._register(F(this.textarea, `blur`, () => this._handleTextAreaBlur())),
      ...
      this._instantiationService.setService(w, this._charSizeService),
      (this._themeService = this._instantiationService.createInstance(ja)),
      this._instantiationService.setService(D, this._themeService),
      (this._characterJoinerService = this._instantiationService.createInstance(ai)),
      this._instantiationService.setService(xe, this._characterJoinerService),
      (this._renderService = this._register(
        this._instantiationService.createInstance(ea, this.rows, this.screenElement),
      )),
      this._instantiationService.setService(E, this._renderService),
      ...
      (this._mouseService = this._instantiationService.createInstance(Ni)),
      this._instantiationService.setService(ye, this._mouseService));
    let r = (this._linkifier.value = this._register(
      this._instantiationService.createInstance(gs, this.screenElement),
    ));
    ...
    (this._renderService.hasRenderer() || this._renderService.setRenderer(this._createRenderer()),
      ...
      (this._viewport = this._register(
        this._instantiationService.createInstance(Wr, this.element, this.screenElement),
      )),
      this._register(
      ...
      (this._selectionService = this._register(
        this._instantiationService.createInstance(Sa, this.element, this.screenElement, r),
      )),
      this._instantiationService.setService(be, this._selectionService),
      this._register(
      ...
      this._register(this._instantiationService.createInstance(Gr, this.screenElement)),
      this._register(
        F(this.element, `mousedown`, (e) => this._selectionService.handleMouseDown(e)),
      ),
      this.coreMouseService.areMouseEventsActive
        ? (this._selectionService.disable(), this.element.classList.add(`enable-mouse-events`))
      ...
      this.options.overviewRuler.width &&
        (this._overviewRulerRenderer = this._register(
          this._instantiationService.createInstance(Xr, this._viewportElement, this.screenElement),
        )),
      ...
      this.coreMouseService.onProtocolChange((e) => {
        (e
          ...
          e & 4
            ...
            : (this._document.removeEventListener(`mousemove`, r.mousedrag), (r.mousedrag = null)));
      }),
    ),
  ...
  paste(e) {
    p(e, this.textarea, this.coreService, this.optionsService);
  }
  ...
  _keyDown(e) {
    ...
    if (
      ((n.key === R.ETX || n.key === R.CR) && (this.textarea.value = ``),
  ...
  _keyUp(e) {
    ((this._keyDownSeen = !1),
      !(this._customKeyEventHandler && this._customKeyEventHandler(e) === !1) &&
        (ys(e) || this.focus(), this.updateCursorStyle(e), (this._keyPressHandled = !1)));
  }
  _keyPress(e) {
    let t;
    if (
    ...
    return !t || ((e.altKey || e.ctrlKey || e.metaKey) && !this._isThirdLevelShift(this.browser, e))
      ? !1
  ...
  _reportFocus() {
    this.element?.classList.contains(`focus`)
      ? this.coreService.triggerDataEvent(R.ESC + `[I`)
      : this.coreService.triggerDataEvent(R.ESC + `[O`);
  }
...
var bs = class {
  ...
  xs = class {
    ...
    getCell(e, t) {
      if (!(e < 0 || e >= this._line.length))
        return t ? (this._line.loadCell(e, t), t) : this._line.loadCell(e, new v());
    }
  ...
  Cs = class extends A {
    constructor(e) {
      (super(),
        (this._core = e),
        (this._onBufferChange = this._register(new N())),
        (this.onBufferChange = this._onBufferChange.event),
        (this._normal = new Ss(this._core.buffers.normal, `normal`)),
        (this._alternate = new Ss(this._core.buffers.alt, `alternate`)),
  ...
  Os = class extends A {
    constructor(e) {
      (super(),
        (this._core = this._register(new vs(e))),
        (this._addonManager = this._register(new bs())),
    ...
    _checkReadonlyOptions(e) {
      if (Es.includes(e)) throw Error(`Option "${e}" can only be set in the constructor`);
    }
    _checkProposedApi() {
    ...
    get parser() {
      return ((this._parser ||= new ws(this._core)), this._parser);
    }
    get unicode() {
      return (this._checkProposedApi(), new Ts(this._core));
    }
    get textarea() {
    ...
    get buffer() {
      return ((this._buffer ||= this._register(new Cs(this._core))), this._buffer);
    }
    get markers() {
...
`,
    ...
    _verifyIntegers(...e) {
      for (Ds of e)
        if (Ds === 1 / 0 || isNaN(Ds) || Ds % 1 != 0) throw Error(`This API only accepts integers`);
    }
    _verifyPositiveIntegers(...e) {
      for (Ds of e)
        if (Ds && (Ds === 1 / 0 || isNaN(Ds) || Ds % 1 != 0 || Ds < 0))
          throw Error(`This API only accepts positive integers`);
    }
  };
export { Os as Terminal };
