const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/things-COaJP7yS.js",
      "assets/jsx-runtime-ByY1xr43.js",
      "assets/fetch-XH3LLe-O.js",
      "assets/stream-BOdcElmA.js",
      "assets/routes-DjuduImk.js",
    ]),
) => i.map((i) => d[i]);
...
var zl = `modulepreload`,
  ...
  q = sc(`/things`)({
    component: lc(
      () => K(() => import(`./things-COaJP7yS.js`), __vite__mapDeps([0, 1, 2])),
      `component`,
    ),
  }),
  J = sc(`/stream`)({
    component: lc(
      () => K(() => import(`./stream-BOdcElmA.js`), __vite__mapDeps([3, 1, 2])),
      `component`,
    ),
  });
function Y(e) {
...
function Vl(e, t) {
  let n = Object.create(null);
  if (e) for (let t of Object.keys(e)) Y(t) && (n[t] = e[t]);
  if (t && typeof t == `object`) for (let e of Object.keys(t)) Y(e) && (n[e] = t[e]);
  return n;
}
function Hl(e) {
  if (!e) return Object.create(null);
  let t = Object.create(null);
  for (let n of Object.keys(e)) Y(n) && (t[n] = e[n]);
  return t;
}
var Ul = () => {
    ...
    return (
      ...
      Object.assign((e) => Wl(void 0, { ...n, ...e }), {
        ...
        middleware: (e) => {
          ...
          let r = Wl(void 0, { ...n, middleware: t });
          return ((r[f] = !0), r);
        },
        inputValidator: (e) => Wl(void 0, { ...n, inputValidator: e }),
        handler: (...e) => {
          let [t, r] = e,
            ...
            Object.assign(
              ...
              },
              {
                ...
                __executeServer: async (e) => {
                  ...
                  return await Gl(a, `server`, {
                    ...t,
                    ...e,
                    serverFnMeta: t.serverFnMeta,
                    context: Vl(e.context, r),
                    request: n.request,
...
async function Gl(e, t, n) {
  let r = X([...(v()?.functionMiddleware || []), ...e]);
  if (t === `server`) {
    let e = Ul({ throwIfNotFound: !1 });
  ...
  let i = async (e) => {
    ...
    try {
      `inputValidator` in n.options &&
        ...
        t === `server` &&
        (e.data = await Kl(n.options.inputValidator, e.data));
      let r;
      if (
        (t === `client`
        ...
        let t = async (t = {}) => {
            let n = await i({
              ...e,
              ...t,
              context: Vl(e.context, t.context),
              sendContext: Vl(e.sendContext, t.sendContext),
...
var Jl = () => K(() => import(`./routes-DjuduImk.js`), __vite__mapDeps([4, 1])),
  Yl = Wl({ method: `GET` }).handler(
    zo(`37e67d3ccf1225b287d37f9049d00eb6cc2b71abed75aa21d6cf45b6bbe99560`),
  ),
  Xl = sc(`/`)({ loader: () => Yl(), component: lc(Jl, `component`) }),
  Zl = q.update({ id: `/things`, path: `/things`, getParentRoute: () => Ll }),
  Ql = J.update({ id: `/stream`, path: `/stream`, getParentRoute: () => Ll }),
  $l = {
    IndexRoute: Xl.update({ id: `/`, path: `/`, getParentRoute: () => Ll }),
    StreamRoute: Ql,
    ThingsRoute: Zl,
  },
  eu = Ll._addFileChildren($l);
function tu() {
  return Cc({ routeTree: eu, scrollRestoration: !0 });
}
var nu = tu;
async function ru() {
  let e = await nu(),
...
function ou() {
  return (
    (au ||= iu()), (0, V.jsx)($o, { promise: au, children: (e) => (0, V.jsx)(Ec, { router: e }) })
  );
}
var su = l();
(0, B.startTransition)(() => {
  (0, su.hydrateRoot)(document, (0, V.jsx)(B.StrictMode, { children: (0, V.jsx)(ou, {}) }));
});
export {
  Hc as _,
  pl as a,
