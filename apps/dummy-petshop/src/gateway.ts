 ...
 * All three gateways validate the SAME sealed access token petshop's OAuth
 * issues; they differ only in HOW that token is presented, which is exactly
 * the axis the OS side proves:
 *
