/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: 6ccc3c1f8faad5ac1c7cbd8207bd2b47)
// Runtime types generated with workerd@1.20260424.1 2026-05-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ProjectDurableObject" | "AgentDurableObject" | "RepoDurableObject" | "StreamDurableObject";
	}
	interface Env {
		ARTIFACTS: Artifacts;
		LOADER: WorkerLoader;
		ARTIFACTS_ACCOUNT_ID: "376ef7ed81b0573f93524de763666c15";
		ARTIFACTS_NAMESPACE: "minimal-itx-v2-repos";
