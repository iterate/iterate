...
function DebugPage() {
  ...
  const handleServerLogDemo = useCallback(async () => {
    console.log("[example] rich server log demo button pressed");
    setDemoBusy(true);
    ...
    try {
      ...
      console.log("[example] rich server log demo result", result);
    ...
    <div className="space-y-8 p-4">
      <section className="space-y-3">
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">Child preview proof branch variant two.</p>
        </div>
      ...
      <section className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            ...
            variant="outline"
            onClick={() =>
              toast.success("Example success toast", {
