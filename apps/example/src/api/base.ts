...
import { useEvlog } from "@iterate-com/shared/apps/middleware";
...
// - `useEvlog()` grows execution context with requestId/logger for
//   downstream handlers: https://orpc.dev/docs/middleware
export const os = implement(exampleContract).$context<ExampleInitialOrpcContext>().use(useEvlog());
