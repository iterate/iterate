...
CREATE INDEX `idx_event_stream_subscriptions_path` ON `event_stream_subscriptions` (`event_stream_path`);--> statement-breakpoint
CREATE INDEX `idx_event_stream_subscriptions_type` ON `event_stream_subscriptions` (`type`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_event_streams_last_event_created_at` ON `event_streams` (`last_event_created_at`);--> statement-breakpoint
CREATE TABLE `events` (
	`path` text NOT NULL,
