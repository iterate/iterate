...
Motivated by OS Project-bound Durable Objects such as `ProjectDurableObject`
...
- Do not keep a compatibility path; OS is a POC.
...
- Update Durable Object utility README examples to avoid `name` inside domain
  structured names.
- Update OS Project/Codemode docs to describe Project-bound Durable Objects by
