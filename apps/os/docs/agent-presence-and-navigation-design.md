...
- Repository typechecking and zero-warning linting pass. The `apps/os` unit suite passes 190 files and 1,866 runnable tests, with one explicitly skipped test.
