...
| `<n>-integration`                 | `integration.ts`                   | `IntegrationDurableObject` (per-(project, integration, account) lifecycle + account stream processors, incl. the Slack thread router)                                                                 | own ns, `INTEGRATION_INGRESS`, `SECRET`, `AGENT`, `SLACK_AGENT`, `STREAM`, `DO_CATALOG`, `GLOBAL_STREAM_NAMESPACE`, slack token | none                                                                      |
