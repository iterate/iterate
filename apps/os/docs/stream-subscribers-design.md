...
{mode: "cross-post", path: targetPath}}`. The spine combines that path with the source stream's
  project scope and dials the sibling Stream DO directly. New first-party
