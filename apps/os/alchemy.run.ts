...
async function setupDurableObjects() {
  ...
  const INSTALLATION_BUILD_MANAGER = await Container<
    import("./backend/worker.ts").InstallationBuildManager
  >("installation-build-manager", {
    className: "InstallationBuildManager",
