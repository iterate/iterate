...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      create:
        "Create this repo and wait until it is usable: appends the atomic birth batch (`repo/created` + the repo processor subscription), waits for the processor to consume it, then for `repo/ready` (the backing Artifacts repository exists).",
  ...
  },
  {
    ...
    summary: "The `repo/created` payload — the repo's birth certificate.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
