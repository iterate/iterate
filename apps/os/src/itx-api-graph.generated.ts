  ...
  },
  {
    ...
    memberSummaries: {
      ...
      getDefaultBirthEvents:
        "The platform-default personality for this agent, as PLAIN KEYED EVENTS — ready to append (plus your own tweaks, plus `agent/birth-finalized`) from a config worker's `agent/created` handler.",
      interpretResponse:
        "Interpret ONE committed event on this agent's stream and append its consequences — the platform-implemented interpretation service.",
