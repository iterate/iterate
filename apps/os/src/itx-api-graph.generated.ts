...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      configure: "Set THIS agent's policy: system prompt, model, and/or GitHub behavior.",
  ...
  },
  {
    ...
    memberSummaries: {},
    referencedTypeNames: ["GithubAgentConfigurationInput"],
  },
  {
  ...
  {
    name: "GithubAgentConfigurationInput",
    kind: "typeAlias",
    sourceText:
