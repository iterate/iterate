...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      resendCopyList: "Retry sending this source's current list to one receiving stream.",
      subscribeToEventsFrom:
        "Configure this stream to durably receive matching events from `source`.",
  ...
  {
    name: "CommittedCopyListRecordedEvent",
    kind: "typeAlias",
    sourceText:
    ...
    summary: "One committed receiver event recording a source stream's complete copy list.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
    name: "CommittedCopyListConfirmedEvent",
    kind: "typeAlias",
    sourceText:
    ...
    summary: "One committed source event confirming the receiver recorded its copy list.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
