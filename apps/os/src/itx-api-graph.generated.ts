...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      create:
        "Register (for a prospective slug), append the complete root birth batch, drive both armed processors through it, wait for `project/ready`, and return this same handle.",
      identity:
