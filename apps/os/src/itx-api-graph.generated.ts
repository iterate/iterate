...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    referencedTypeNames: ["Description", "Project", "ProcessEventBatch", "ProjectListEntry"],
  },
  {
    name: "LiveStateRpc",
    kind: "interface",
  ...
  },
  {
    ...
    summary:
      "Project client roster: the logical endpoints that have ever connected via `projects.connect`, plus per-client handles whose `capabilities.*` fans out over the currently open connections.",
    memberSummaries: {
      get: "One client handle by stream path; pure addressing, never creates.",
      list: "Known clients, read from the collection processor's reduced roster.",
    },
    referencedTypeNames: [
      "Description",
      "StreamProcessorRpc",
      "ClientCollectionProcessorState",
      "LiveStateRpc",
      "Client",
      "ClientListItem",
    ],
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      invokeClientCapabilities:
        "Fan one client-capability call out over this stream's open client connections (`openConnection` with `capabilities`).",
  ...
  },
  {
    ...
    summary:
      "One project client — a logical endpoint (a browser, a CLI, a device) identified by its caller-chosen stream path.",
    memberSummaries: {
      stream: "The client's own event stream (the stream half; capabilities are the itx half).",
      connections: "Open client connections, read from the stream's live runtime table.",
      getConnection: "One connection by key — pure addressing.",
      invokeCapability:
        "The prototype hop's dispatch door: every dotted call goes through `.capabilities`.",
    },
    referencedTypeNames: ["Description", "Stream", "ClientConnectionListItem", "ClientConnection"],
  },
  {
  ...
  },
  {
    ...
    summary: "One connection on a client, addressed by connectionKey.",
    memberSummaries: {
      close: 'Kick this connection from the platform side (close reason "kicked").',
      invokeCapability:
        "The prototype hop's dispatch door: dotted calls go through `.capabilities`, single-target.",
    },
    referencedTypeNames: ["Description"],
  ...
  {
    name: "ClientCollectionProcessorState",
    kind: "typeAlias",
    sourceText:
    ...
    summary: "The singleton client collection processor's reduced roster state.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
    ...
    summary: "One roster row from `itx.clients.list()`: last-known presence, not liveness.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
  ...
  },
  {
    ...
    memberSummaries: {},
    referencedTypeNames: ["AgentProcessorState"],
  },
  {
  ...
  },
  {
    ...
    summary: "One open client connection, read from the client stream's LIVE runtime table.",
    memberSummaries: {},
    referencedTypeNames: ["ConnectionOpenerDescriptor"],
  },
  {
