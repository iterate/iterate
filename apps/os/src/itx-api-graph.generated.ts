...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      subscribe:
        'Session-scoped live event delivery (the public "ephemeral" subscription lane; a protected platform observability push is the only durable opt-in): `processEventBatch` first receives durable history after `replayAfterOffset`, then new commits.',
      acceptCrossPost:
