...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  {
    name: "RemoteCapabilityCollection",
    kind: "interface",
    sourceText:
    ...
    summary: "Externally deployed apps as capabilities.",
    memberSummaries: {
      get: "Dial `url` (ws/wss — or http/https, upgraded) with `headers` and return the remote Cap'n Web session's root stub.",
    },
    referencedTypeNames: ["Description"],
  },
  {
