...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      subscriptionHealth:
        "Roll up subscription delivery health across the project's streams: the root stream, the well-known platform streams, and the most recently active agent streams (bounded — see subscription-health.ts).",
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      syncFromTemplate:
        "Update this repo from the template it was created from — the durable creation request is the template intent (`empty` creates map to the picker's Default template, so every seeded repo is syncable; imports are refused with directions to syncFromGithub).",
  ...
  {
    name: "ProjectSubscriptionHealth",
    kind: "typeAlias",
    sourceText:
    ...
    summary: "What `itx.subscriptionHealth()` returns.",
    memberSummaries: {},
    referencedTypeNames: ["StreamSubscriptionHealth"],
  },
  {
  ...
  },
  {
    ...
    summary: "One scanned stream's troubled subscriptions, or the read error that hid them.",
    memberSummaries: {},
    referencedTypeNames: ["SubscriptionHealthEntry"],
  },
  {
  ...
  },
  {
    ...
    summary: "What `repo.syncFromTemplate` returns.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
  ...
  },
  {
    ...
    summary: "One troubled subscription in the rollup: its tier plus the delivery facts behind it.",
    memberSummaries: {},
    referencedTypeNames: ["SubscriptionHealthTier"],
  },
  {
  ...
  },
  {
    ...
    summary:
      "Severity tiers, in the order the dashboard escalates them: - `halted` — delivery durably gave up; nothing flows until a human resumes it (red badge); - `lagging` — delivery is failing and backing off right now, so events are piling up (amber badge); - `informational` — a historical `lastError` on an otherwise-delivering subscription (the skip policy leaves these standing for a long time); shown as a quiet line, never a badge — alarm fatigue kills the surface.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
