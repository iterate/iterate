...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      indexStream:
        "Re-index one stream from the beginning — the repair verb for streams that predate search indexing or whose durable projection was parked and later repaired (`path` is the stream path, e.g.",
      indexRepo:
