...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    referencedTypeNames: ["Description", "StreamProcessorRpc", "EmailAttachmentInput"],
  },
  {
    name: "Docs",
    kind: "interface",
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      resendCrossPostList: "Retry sending this source's current list to one receiving stream.",
      receiveCrossPostsFrom:
        "Configure this stream to durably receive matching events from `source`.",
  ...
  {
    name: "CommittedCrossPostListRecordedEvent",
    kind: "typeAlias",
    sourceText:
    ...
    summary: "One committed receiver event recording a source stream's complete cross-post list.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
    name: "CommittedCrossPostListConfirmedEvent",
    kind: "typeAlias",
    sourceText:
    ...
    summary: "One committed source event confirming the receiver recorded its cross-post list.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
