...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      indexStream:
        "Re-index one stream from the beginning — the repair verb for streams that predate search indexing or an automatic reconciliation task preserved in the dead-letter queue (`path` is the stream path, e.g.",
      indexRepo:
  ...
  },
  {
    ...
    memberSummaries: {},
    referencedTypeNames: ["ProjectProcessorState", "StreamIndexRow", "AgentRecord"],
  },
  {
  ...
  },
  {
    ...
    summary: "The project catalog's complete current projection for one explicitly created agent.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
