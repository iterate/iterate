...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      subscriptionHealth:
        "Roll up subscription delivery health across the project's streams: the root stream, the well-known platform streams, and the most recently active agent streams.",
