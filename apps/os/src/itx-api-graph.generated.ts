...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      capabilityHost:
        "The agent scope's own capability host (provide/revoke/runScript/ __describe) — and the explicit dotted access point for the scope's DYNAMIC capabilities: `agents.get(path).capabilityHost.someTool(args)`.",
      provideCapability:
        "Shortcut for `capabilityHost.provideCapability` (mounts on THIS agent's scope).",
      revokeCapability: "Shortcut for `capabilityHost.revokeCapability`.",
      ...
      chat: "The agent's web-chat output surface (what the user sees).",
      create:
