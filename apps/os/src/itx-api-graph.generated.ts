...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      subscribe:
        'Session-scoped live event delivery (the "ephemeral" subscription lane — also the only lane that receives `ephemeral: true` events): `processEventBatch` first receives durable history after `replayAfterOffset`, then new commits.',
      acceptCrossPost:
