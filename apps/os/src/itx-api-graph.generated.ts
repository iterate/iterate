...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      scope:
        "A NARROWER itx for `path` — the one door for handing an itx to code that must not hold this scope's authority (a visitor's browser session, a helper that should only talk).",
