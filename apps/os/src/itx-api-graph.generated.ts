...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    summary:
      "One durable subscription on one source stream: its committed configuration and cursor (`describe`), the uniform confirmation barrier (`waitUntilConfirmed` — works for EVERY receiver kind off the confirmed cursor), and — for processor-wake subscriptions — the hosted processor instance's facade.",
    memberSummaries: {
      describe:
