...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    summary: "`getScriptResult` options.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
    name: "ScriptResultSlicedFrom",
    kind: "typeAlias",
    sourceText:
    ...
    summary:
      "A sliced read's provenance: the canonical text's total length plus the resolved (clamped) offsets actually served — what a paging loop needs.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
