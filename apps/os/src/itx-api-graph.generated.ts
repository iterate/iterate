  ...
  },
  {
    ...
    memberSummaries: {
      ...
      mobilePreviewChannels:
        "Active EAS Update channels for the iterate mobile app, newest first — the data behind the phone's preview-channel browser (each PR touching apps/mobile publishes to a channel named after its branch; `preview` is main).",
