...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      message: "Send a message to this agent — THE inbound method for every caller.",
  ...
  },
  {
    ...
    summary: "Expected refusal of an AI call: a spending pause or a bounded temporary rate limit.",
    memberSummaries: {},
    referencedTypeNames: ["AiBudgetStop", "AiRateLimitStop"],
  },
  {
  ...
  },
  {
    ...
    summary: "A confirmed spending-limit refusal, with provider evidence for the pause UI.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
    name: "AiRateLimitStop",
    kind: "typeAlias",
    sourceText:
    ...
    summary: "A temporary rate refusal whose delay is bounded before journal persistence.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
