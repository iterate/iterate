...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    summary: "The wire arguments accepted by the single append operation.",
    memberSummaries: {},
    referencedTypeNames: ["StreamEventInput", "StreamAppendResultOptions"],
  },
  {
    name: "StreamAppendResult",
    kind: "typeAlias",
    sourceText:
      "/** The optional result projection returned by append. */\nexport type StreamAppendResult = StreamEvent[] | number[] | void;",
    summary: "The optional result projection returned by append.",
    memberSummaries: {},
    referencedTypeNames: ["StreamEvent"],
  },
  {
  ...
  {
    name: "StreamAppendResultOptions",
    kind: "typeAlias",
    sourceText:
    ...
    summary: "Optional result projection for `Stream.append`.",
    memberSummaries: {},
    referencedTypeNames: [],
  },
  {
