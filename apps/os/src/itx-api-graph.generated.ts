...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      applyIfUnchanged: "Apply a structured whole-file replacement only at its exact source head.",
  ...
  },
  {
    ...
    summary: "Readable message content with optional resources addressed by inline ref:// links.",
    memberSummaries: {},
    referencedTypeNames: ["Reference"],
  },
  {
    name: "FileData",
    kind: "typeAlias",
