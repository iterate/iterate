...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      runtimeLiveState: "Push-driven stream runtime state for polling-free debug surfaces.",
  ...
  },
  {
    ...
    summary: "Serializable stream-core and delivery-runtime projection used by debug surfaces.",
    memberSummaries: {},
    referencedTypeNames: [
