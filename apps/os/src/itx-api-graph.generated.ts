...
export const ITX_API_DECLARATIONS: readonly ItxApiDeclaration[] = [
  ...
  },
  {
    ...
    memberSummaries: {
      ...
      create:
        "Create a workspace: append its `workspace/created` birth certificate (carrying the initial mount table) plus the processor subscription to the workspace's own stream, then wait until the fold has processed the birth.",
    },
