...
// every facet is created, context/facet-host.ts `FacetHost#invoke`; where every stateless worker is
...
//      `itx.workspaces.create(path)` take any path (library.ts `createEntity`; `/repos/<name>` is a
