...
// client, with nothing naming the step (2026-09-24, ci-soak-0924). Each step is watched: one that has
// not settled after SLOW_STEP_MS logs `issuer.sign-in-slow` WHILE it still waits — a line that lands
// even when the client gives up first and the invocation is cancelled.
