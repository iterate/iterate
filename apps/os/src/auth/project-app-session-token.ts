 ...
 * Rotating the shared secret invalidates in-flight tokens (a one-time
 * transparent re-login through the still-valid auth session) — no legacy
 * acceptance path by design.
 */
