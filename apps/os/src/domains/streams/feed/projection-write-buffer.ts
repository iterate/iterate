// The shared coordination object between a materialized-view processor and
// its transactional progress store: the processor's
...
// point of the runner/progress-store integration: projection rows and the
// checkpoint must never diverge across a crash.
//
...
export type ProjectionSqlValue = string | number | bigint | Uint8Array | number[] | null;

type BufferedProjectionStatement = { sql: string; params?: ProjectionSqlValue[] };
...
export class ProjectionWriteBuffer {
