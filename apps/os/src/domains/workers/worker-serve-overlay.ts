...
export function workerOverlayHtml(state: WorkerOverlayState): string {
  ...
  root.innerHTML = \`<style>
    ...
    #badge .mark { display: block; width: 100%; height: 100%; border-radius: 9px; box-shadow: 0 2px 10px rgba(0,0,0,.35); }
