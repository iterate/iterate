...
const NAMESPACE_BUILTIN_ROOTS: ReadonlyMap<string, ReadonlySet<string>> = new Map([
  [
    ...
    new Set([
      ...
      // First-party platform sink. It is intentionally absent from
      // BUILTIN_INTEGRATION_SLUGS: unlike connection families, this target is
      // internal and never appears in the public integration catalog.
      "posthog",
      "list",
      "getConnection",
      "startOAuthFlow",
