...
export const DEFAULT_AGENT_SYSTEM_PROMPT = [
  ...
  '- The platform is open source — clone its source into the project ONCE: `await itx.repos.get("/repos/iterate").create({ type: "github-public", owner: "iterate", repo: "iterate", depth: 1 })`, then read "/repos/iterate/..." in any workspace (refresh via syncFromGithub). AI-written summaries: https://deepwiki.com/iterate/iterate.',
].join("\n");
