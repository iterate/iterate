...
// goes through `publishPlatformFacts`, best-effort in waitUntil.
...
test("publishPlatformFacts hands waitUntil a promise that resolves even when the append fails", async () => {
