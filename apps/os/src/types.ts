...
// `stateSchema` (inferred via ProcessorState<Contract>, imported at the top of
// this file); these re-exports keep this module's historical import surface
// working. Same pattern as the StreamEvent shapes above.
