...
// derives the same time (no write) or supersedes it — and a stored time no source still wants (one a
// dead incarnation left, its watchdog's or sweep's included) is rightly superseded, even though workerd then
