...
- `**web-chat-***`: You communicate via Iterate's built-in web chat. Reply directly in your assistant response (no external tool command needed). See [WEB_CHAT.md](./WEB_CHAT.md) for channel-specific instructions.
