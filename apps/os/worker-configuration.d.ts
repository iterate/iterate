/* eslint-disable */
// Generated by Wrangler by running `wrangler types --no-include-runtime` (hash: b0723adbea13251e69f8832f76c43c23)
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./backend/worker");
		durableNamespaces: "IterateAgent" | "SlackAgent" | "OnboardingAgent" | "OrganizationWebSocket" | "Sandbox";
	}
	interface Env {
