...
describe("buildProjectIngressLink", () => {
  it("avoids double slashes when base URL ends with / and path starts with /", () => {
    const url = buildProjectIngressLink({
      baseUrl: "https://3000__mach_01kh90jnk0fk6bzmxnsxcm9fn2.p.os.iterate.com/",
      path: "/terminal",
      query: {
    ...
    expect(url).toBe(
      "https://3000__mach_01kh90jnk0fk6bzmxnsxcm9fn2.p.os.iterate.com/terminal?command=tail+-n+200+-f+%2Fvar%2Flog%2Fpidnap%2Fprocess%2Fdaemon-frontend.log&autorun=true",
    );
