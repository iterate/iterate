// https://github.com/iamcal/emoji-data/blob/master/build/data_emoji_names.txt
const rawData = `\
0023-20E3;hash
0030-20E3;zero
0031-20E3;one
...
export const emojiMapping = Object.fromEntries(
  rawData.split("\n").flatMap((line) => {
    const [code, names] = line.split(";");
    return names.split("/").map((name) => [name, String.fromCodePoint(Number.parseInt(code, 16))]);
  }),
);
