...
//   // Note: Onboarding checks now happen at the root redirect level
//   // and route to /{org}/{estate}/onboarding, not /{org}/onboarding
//   // So we don't need to check onboarding status here
