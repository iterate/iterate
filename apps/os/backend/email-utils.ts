...
const _fetch: import("eslint-plugin-codegen").Preset = ({ cache, dependencies }) => {
  return cache({ maxAge: "52 weeks" }, () => {
    ...
    return ["// prettier-ignore", `export const knownEmailProviderDomains = new Set(${json})`].join(
      "\n",
    );
  });
};

// codegen:hash {input: 989e7871921be7911de09869d3d238ec, output: 156dae2a8860e5d2ec853569c85160c2, timestamp: 2025-12-04T16:59:46.775Z}
// prettier-ignore
export const knownEmailProviderDomains = new Set([
  "0-mail.com",
  "007addict.com",
  "020.co.uk",
  "027168.com",
