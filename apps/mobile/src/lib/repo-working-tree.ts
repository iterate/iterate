/* oxlint-disable iterate/simple-truthiness-check -- buffer `head`/`current` use
 * null as a deliberate "absent" sentinel while "" is real (empty-file) content;
 * truthiness would turn empty files into deletes/creates. */
