...
// PROTOTYPE — CodeMirror 6 bundled by Expo as an offline DOM component. Expo
// hosts this in react-native-webview on SDK 54 and marshals value changes back
// to the native working-tree store.
...
export default class CodeEditorPrototype extends Component<Props> {
