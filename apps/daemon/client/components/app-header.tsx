...
import type { SerializedSession, SerializedTmuxSession } from "@server/trpc/router.ts";
...
interface AppHeaderProps {
  agent?: SerializedSession | null;
  agents?: SerializedSession[];
}
...
interface AgentBreadcrumbDropdownProps {
  currentAgent: SerializedSession;
  agents: SerializedSession[];
}
