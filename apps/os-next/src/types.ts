// types.ts — THE PUBLIC SURFACE, in one place to read and to import (`os-next/types`).
//
...
//   import type { IterateRpcTarget, IterateContextRpcTarget } from "os-next/types";
//
...
//
//   import { AccountContract } from "os-next/types";
