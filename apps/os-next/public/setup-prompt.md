...
`https://dash.iterate2.com/.auth/connect?issuer=<origin>` — the page names their platform's host and
asks before connecting the browser to it.

Docs: `apps/os-next/SELF-HOSTING.md` and `apps/os-next/README.md` in the repository.
