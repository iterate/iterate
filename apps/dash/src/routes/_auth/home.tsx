...
// apps/os's root decides: exactly one project → that project; otherwise the projects list — read
// off the tree (components/organization-tree.tsx) once it has loaded. The list itself never
// redirects — the switcher's "All projects" must not hijack a single-project person back.
