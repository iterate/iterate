// A facet's live state as the dash shows it inside the context view's processors panel: the SDK's
// `useLiveState` over the facet's `liveSnapshot()` door (the core reduce answers the same door under
// the name `core`), rendered as YAML/JSON. The hook lives on this side of the boundary — packages/ui
// stays free of the SDK — so the page hands the panel this component per facet.
