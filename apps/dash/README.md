...
Deploy: `pnpm run deploy --env prd` serves `https://dash.iterate.com` (a route on the
`iterate.com` zone; `pnpm ensure-resources --env prd` creates the proxied DNS record). See
