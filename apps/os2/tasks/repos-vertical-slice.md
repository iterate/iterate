...
Build the first OS2 Repos slice: project-scoped Repos backed by Cloudflare
Artifacts, exposed through a capability, codemode, oRPC, and a small browser UI.

## Domain Model

- **Repo** is the OS2 domain object.
...
Add a Repo stream processor under `apps/os2/src/domains/repos`.
