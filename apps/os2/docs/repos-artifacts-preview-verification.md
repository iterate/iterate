...
Repos are OS2 domain objects backed by Cloudflare Artifacts. The public OS2 word
...
The deployed `os2-preview-2` Worker settings were checked through the Cloudflare
API and include:
...
```text
https://cc7f6f461fbe823c199da2b27f9e0ff3.artifacts.cloudflare.net/git/os2-preview-2-repos/proj__os__01krcc1gw2endaxnw129rdm4cm--codex-artifacts-1778533765369.git
```
