...
Inbound MCP Server owns OS2's project-scoped MCP server surface, including MCP
connections that can run code against a real project.

This is distinct from outbound MCP clients that codemode can call as tools.
