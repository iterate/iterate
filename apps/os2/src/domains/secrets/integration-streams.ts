...
export const SLACK_INTEGRATION_PROCESSOR_SLUG = "slack-integration";
...
export const SLACK_WEBHOOKS_STREAM_PATH = StreamPath.parse("/integrations/slack/webhooks");

export const SLACK_CONNECTED_EVENT_TYPE = "events.iterate.com/slack-integration/connected";
export const SLACK_DISCONNECTED_EVENT_TYPE = "events.iterate.com/slack-integration/disconnected";
