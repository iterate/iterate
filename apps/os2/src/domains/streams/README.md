...
Streams is the OS2 project-bound adapter around the shared namespace/path stream
runtime in `packages/shared/src/streams`.

OS2 uses the stable Project ID as the stream namespace for project streams, but
