...
export const Route = createFileRoute("/_app/orgs/$organizationSlug/projects/$projectSlug/secrets/")(
  {
  ...
  const upsertSecret = useMutation(
    orpc.project.secrets.upsert.mutationOptions({
      onSuccess: async (secret) => {
        ...
        form.reset();
        void navigate({
          to: "/orgs/$organizationSlug/projects/$projectSlug/secrets/$secretId",
          params: {
