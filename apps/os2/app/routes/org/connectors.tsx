...
export const Route = createFileRoute("/_auth-required.layout/_/$organizationSlug/connectors")({
  component: OrgConnectorsPage,
});

function OrgConnectorsPage() {
  const handleSlackConnect = () => {
    // This would trigger the Slack bot OAuth flow
    ...
    <div className="p-8 max-w-4xl">
      ...
      <div className="grid gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              Connect Slack to receive notifications and interact with OS2 directly from your workspace.
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              Connect Google to enable Gmail and Calendar integrations.
            </p>
