...
export interface FileRoutesById {
  ...
  '/_auth.layout/$organizationSlug/$instanceSlug': typeof orgInstanceLayoutRouteWithChildren
  ...
  '/_auth.layout/$organizationSlug/$instanceSlug/': typeof orgInstanceIndexRoute
}
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/_auth.layout/$organizationSlug/$instanceSlug'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_auth.layout/$organizationSlug/$instanceSlug': {
      id: '/_auth.layout/$organizationSlug/$instanceSlug'
      path: '/$instanceSlug'
