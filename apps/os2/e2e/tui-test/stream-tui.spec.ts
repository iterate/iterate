...
const projectSlugOrId = process.env.OS2_TUI_TEST_PROJECT_SLUG_OR_ID || "missing-os2-tui-project";
const testWithProject = process.env.OS2_TUI_TEST_PROJECT_SLUG_OR_ID ? test : test.skip;
const snapshotTest =
  process.env.OS2_TUI_TEST_PROJECT_SLUG_OR_ID && process.env.OS2_TUI_SNAPSHOT === "1"
    ? test
    : test.skip;
