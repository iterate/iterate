...
```bash
pnpm --dir apps/os2 cli stream-tui --project-slug-or-id public --stream-path ...
```

Run the stable workflow/layout assertions with:

```bash
pnpm --dir apps/os2 test:e2e:tui
```
