  ...
  return (
    <BlogLayout>
      <LegalPage title="Terms of Service">
        ...
        <p>
          We are Nustom (UK) Ltd., doing business as Iterate (<strong>"Company"</strong>,{" "}
          <strong>"we"</strong>, <strong>"us"</strong>, <strong>"our"</strong>).
        </p>
        <p>
          We operate the website{" "}
          <a href="https://www.iterate.com" target="_blank" rel="noopener noreferrer">
            https://www.iterate.com
          </a>{" "}
        ...
        <p>You can contact us by email at team@iterate.com</p>
        <p>
          These Legal Terms constitute a legally binding agreement made between you, whether
          personally or on behalf of an entity (<strong>"you"</strong>), and Nustom (UK) Ltd.,
        ...
        <p>
          ...
          team@iterate.com. If we ever grant you the permission to post, reproduce, or publicly
        ...
        <p>
          ...
          personal information, or other material ("Contributions"). Any Submission that is publicly
        ...
        <p>
          ...
          Contributions accessible through the Services by linking your account through the Services
        ...
        <ul>
          <li>
            ...
            upload, or transmit through the Services any Submission nor post any Contribution that
        ...
        <p>
          ...
          harmful or in breach of these Legal Terms. If we remove or edit any such Contributions, we
        ...
        <p>
          ...
          with our Services, please email us at team@iterate.com.
        </p>
        <h3>Fee Changes</h3>
        <p>
        ...
        <h2 id="sitemanage">14. SERVICES MANAGEMENT</h2>
        <p>
        ...
        <h2 id="ppyes">15. PRIVACY POLICY</h2>
        <p>
          We care about data privacy and security. Please review our Privacy Policy:{" "}
          <a href="/privacy">https://www.iterate.com/privacy</a>. By using the Services, you agree
          to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be
          advised the Services are hosted in the United Kingdom and United States. If you access the
          ...
          United Kingdom and United States, then through your continued use of the Services, you are
          transferring your data to the United Kingdom and United States, and you expressly consent
          to have your data transferred to and processed in the United Kingdom and United States.
        </p>

        <h2 id="terms">16. TERM AND TERMINATION</h2>
        <p>
          ...
          CONTAINED IN THESE LEGAL TERMS OR OF ANY APPLICABLE LAW OR REGULATIONS. WE MAY TERMINATE
        ...
        <h2 id="modifications">17. MODIFICATIONS AND INTERRUPTIONS</h2>
        <p>
        ...
        <p>
          ...
          Sales of Goods is expressly excluded. If your habitual residence is in the EU, and you are
          a consumer, you additionally possess the protection provided to you by obligatory
          provisions of the law in your country to residence. Nustom (UK) Ltd. and yourself both
          agree to submit to the non-exclusive jurisdiction of the courts of __________, which means
          that you may make a claim to defend your consumer protection rights in regards to these
        ...
        <p>
          ...
          relationship established by these Legal Terms to the jurisdiction of the __________
          courts. Nustom (UK) Ltd. shall also maintain the right to bring proceedings as to the
        ...
        <h2 id="corrections">20. CORRECTIONS</h2>
        <p>
        ...
        <h2 id="userdata">24. USER DATA</h2>
        <p>
        ...
        <h2 id="electronic">25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
        <p>
