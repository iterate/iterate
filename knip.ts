...
export default {
  ...
  workspaces: {
    ...
    scripts: {
      ...
      entry: [
        "ci/{create-release,do-duration-alert,do-duration-probe,loc-report,main-e2e-alert,notify,posthog-events,pr-dashboard,prd-fault-alarm,prd-post-deploy-check,preview-tested-commit,sync-ci-telemetry,upload-test-telemetry}.ts",
