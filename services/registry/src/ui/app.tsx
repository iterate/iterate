...
interface IngressEnvValues {
  readonly ITERATE_INGRESS_HOST: string | null;
  readonly ITERATE_INGRESS_ROUTING_TYPE: "dunder-prefix" | "subdomain-host";
  readonly ITERATE_INGRESS_DEFAULT_SERVICE: string;
}
        ...
        <section className="space-y-5">
          ...
          <div className="space-y-3 rounded-lg border bg-muted p-3 text-xs">
            ...
            <p className="break-all text-[11px]">
              ...
              <span className="font-mono">{ingressEnv?.ITERATE_INGRESS_HOST ?? "unset"}</span>
            </p>
            <p className="break-all text-[11px]">
              ITERATE_INGRESS_ROUTING_TYPE:{" "}
              <span className="font-mono">
                {ingressEnv?.ITERATE_INGRESS_ROUTING_TYPE ?? "subdomain-host"}
              </span>
            </p>
            <p className="break-all text-[11px]">
              ITERATE_INGRESS_DEFAULT_SERVICE:{" "}
              <span className="font-mono">
                {ingressEnv?.ITERATE_INGRESS_DEFAULT_SERVICE ?? "home"}
              </span>
            </p>
          </div>
